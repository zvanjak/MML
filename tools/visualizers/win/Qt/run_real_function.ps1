...
# Using Qt MML_RealFunctionVisualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_RealFunctionVisualizer\MML_RealFunctionVisualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\RealFunction"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Real Function Visualizer Runner (Qt)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
