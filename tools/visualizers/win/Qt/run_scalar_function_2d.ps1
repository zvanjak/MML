# PowerShell Script to visualize Scalar Function 2D data files
# Using Qt MML_ScalarFunction2D_Visualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_ScalarFunction2D_Visualizer\MML_ScalarFunction2D_Visualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\ScalarFunction2D"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Scalar Function 2D Visualizer Runner (Qt)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
