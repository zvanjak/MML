# PowerShell Script to visualize Parametric Curve 2D data files
# Using Qt MML_ParametricCurve2D_Visualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_ParametricCurve2D_Visualizer\MML_ParametricCurve2D_Visualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\ParametricCurve2D"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Parametric Curve 2D Visualizer Runner (Qt)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
