# PowerShell Script to visualize Vector Field 3D data files
# Using Qt MML_VectorField3D_Visualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_VectorField3D_Visualizer\MML_VectorField3D_Visualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\VectorFieldVisualizer3D"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Vector Field 3D Visualizer Runner (Qt)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
