# PowerShell Script to visualize Vector Field 2D data files
# Using Qt MML_VectorField2D_Visualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_VectorField2D_Visualizer\MML_VectorField2D_Visualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\VectorField2D\Basic"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Vector Field 2D Visualizer Runner (Qt)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
