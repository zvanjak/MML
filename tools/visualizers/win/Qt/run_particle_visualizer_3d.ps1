# PowerShell Script to visualize Particle Simulation 3D data files
# Using Qt MML_ParticleVisualizer3D

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_ParticleVisualizer3D\MML_ParticleVisualizer3D.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\ParticleVisualizer3D"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Particle Visualizer 3D Runner (Qt)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
