...
# Script to run MML_VectorField2D_Visualizer_FLTK with test data

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
VISUALIZER="$SCRIPT_DIR/MML_VectorField2D_Visualizer_FLTK"
DATA_DIR="$SCRIPT_DIR/../../../data/VectorField2D/Basic"
...
echo "Running MML_VectorField2D_Visualizer with test data files..."
