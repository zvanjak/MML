...
# Script to run MML_ParametricCurve3D_Visualizer with all test data files

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
VISUALIZER="$SCRIPT_DIR/MML_ParametricCurve3D_Visualizer"
DATA_DIR="$SCRIPT_DIR/../../../data/ParametricCurve3D/Basic"
...
echo "Running MML_ParametricCurve3D_Visualizer with test data files..."
