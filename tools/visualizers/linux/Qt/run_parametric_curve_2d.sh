...
# Script to visualize Parametric Curve 2D data files
# Using Qt MML_ParametricCurve2D_Visualizer

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
VISUALIZER="$SCRIPT_DIR/MML_ParametricCurve2D_Visualizer"
...
echo -e "${GREEN}========================================"
echo -e "Parametric Curve 2D Visualizer Runner (Qt)"
echo -e "========================================${NC}"
echo ""
