...
# Script to run MML_ScalarFunction2D_Visualizer with all test data files

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
VISUALIZER="$SCRIPT_DIR/MML_ScalarFunction2D_Visualizer"
DATA_DIR="$SCRIPT_DIR/../../../data/ScalarFunction2D/Basic"
...
echo "Running MML_ScalarFunction2D_Visualizer with test data files..."
