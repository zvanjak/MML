...
namespace MML::TestBeds
{
    ...
    public:
        ...
        const static TestParametricSurfaceRect3& getTestSurface3(int i) { return getListSurfaces()[i]; }

        const static TestParametricSurfaceRect3& getTestSurface3(const std::string &surfaceName)
        {
            const auto* surfaces = getListSurfaces();
            for (int i = 0; i < getNumTestSurfaces3(); i++)
            {
                if (surfaces[i]._surfaceName == surfaceName)
                    return surfaces[i];
            }
    ...
    private:
        ...
        static const TestParametricSurfaceRect3* getListSurfaces();
    };

    // SIOF-SAFE IMPLEMENTATION
    inline const TestParametricSurfaceRect3* ParametricSurfaceTestBed::getListSurfaces()
    {
        static const TestParametricSurfaceRect3 listSurfaces[] = { 
            //==========================================================================================================
    ...
    public:
        ...
        const static TestParametricSurfaceRect3& getExplicitSurface3(int i) { return getListSurfaces()[i]; }
    ...
    // SIOF-SAFE IMPLEMENTATION
    inline const TestParametricSurfaceRect3* ExplicitSurfaceTestBed::getListSurfaces()
    {
        static const TestParametricSurfaceRect3 listSurfaces[] = { 
...
#endif  // __MML_PARAMETRIC_SURFACES_TEST_BED_H
