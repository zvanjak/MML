...
namespace MML::TestBeds
{
    ...
    public:
        ...
        const static TestFunctionScalar<3>& getTestFunctionScalar3(int i)  { return getListFuncScalar3()[i]; }

        const static TestFunctionScalar<3>& getTestFunctionScalar3(const std::string &funcName)
        {
            const auto& funcs = getListFuncScalar3();
    ...
    private:
        ...
        static const TestFunctionScalar<3>* getListFuncScalar3();
    };

    // SIOF-SAFE IMPLEMENTATION
    inline const TestFunctionScalar<3>* ScalarFunctionsTestBed::getListFuncScalar3()
    {
        static const TestFunctionScalar<3> listFuncScalar3[] = { 
