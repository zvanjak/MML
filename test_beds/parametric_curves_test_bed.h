...
#include "../test_data/parametric_curves_defs.h"
...
namespace MML::TestBeds
{
    ...
    public:
        ...
        const static TestCartesianCurve3D& getTestCurve(int i) { return getListCurves()[i]; }
        const static TestCartesianCurve3D& getTestCurveArcLenParam(int i) { return getListCurvesArcLenParam()[i]; }

        const static TestCartesianCurve3D& getTestCurve(const std::string& curveName)
        {
            const auto& curves = getListCurves();
            for (int i = 0; i < getNumTestCurves(); i++)
            {
                if (curves[i]._curveName == curveName)
                    return curves[i];
            }
        ...
        {
            const auto& curves = getListCurvesArcLenParam();
    ...
    private:
        ...
        static const TestCartesianCurve3D* getListCurves();
        static const TestCartesianCurve3D* getListCurvesArcLenParam();
    };

    //==================================================================================================================
    // SIOF-SAFE IMPLEMENTATION: Main test curve collection
    //==================================================================================================================
    inline const TestCartesianCurve3D* ParametricCurvesTestBed::getListCurves()
    {
        static const TestCartesianCurve3D listCurves[] = {
    ...
    //==================================================================================================================
    // SIOF-SAFE IMPLEMENTATION: Arc-length parameterized curves
    //==================================================================================================================
    inline const TestCartesianCurve3D* ParametricCurvesTestBed::getListCurvesArcLenParam()
    {
