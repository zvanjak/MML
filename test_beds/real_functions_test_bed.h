...
namespace MML::TestBeds
{
    ...
    public:
        ...
        const static TestFunctionReal& getFunc(int i)                               { return getListFuncReal()[i]; }
        const static TestFunctionRealWithDerivation& getFuncWithDerivation(int i)   { return getListFuncRealWithDerivation()[i]; }
        const static TestFunctionRealWithIntegral& getFuncWithIntegral(int i)       { return getListFuncRealWithIntegral()[i]; }

        const static TestFunctionReal& getFunc(const std::string &funcName)
        {
          const auto& funcs = getListFuncReal();
          for (int i = 0; i < getNumFunc(); i++)
          {
              if (funcs[i]._funcName == funcName)
                  return funcs[i];
          }
        ...
        {
            const auto& funcs = getListFuncRealWithDerivation();
        ...
        {
            const auto& funcs = getListFuncRealWithIntegral();
        ...
        const static TestFunctionRealWithDerivation& getFuncExtended(int i) { return getListFuncExtended()[i]; }
        const static TestFunctionRealWithIntegral& getFuncExtendedWithIntegral(int i) { return getListFuncExtendedWithIntegral()[i]; }
        
        const static TestFunctionRealWithDerivation& getFuncExtended(const std::string &funcName)
        {
            const auto& funcs = getListFuncExtended();
        ...
        {
            const auto& funcs = getListFuncExtendedWithIntegral();
    ...
    private:
        // SIOF-safe: Construct-on-first-use idiom for static arrays
        static const TestFunctionReal* getListFuncReal();
        static const TestFunctionRealWithDerivation* getListFuncRealWithDerivation();
        static const TestFunctionRealWithIntegral* getListFuncRealWithIntegral();
        static const TestFunctionRealWithDerivation* getListFuncExtended();
        static const TestFunctionRealWithIntegral* getListFuncExtendedWithIntegral();
    };

    //==================================================================================================================
    // SIOF-SAFE IMPLEMENTATION: _listFuncReal
    //==================================================================================================================
    inline const TestFunctionReal* RealFunctionsTestBed::getListFuncReal()
    {
        static const TestFunctionReal listFuncReal[] = { 
                {"Sin", new CompleteRInterval(), 
                        new ClosedInterval(-2.0*Constants::PI, 2.0 * MML::Constants::PI),  
                        [](Real x) -> Real { return sin(x);},  "sin(x)", 
                        [](Real x) -> Real { return cos(x);},  "cos(x)",  
                        [](Real x) -> Real { return -sin(x);}, "-sin(x)",
                        [](Real x) -> Real { return -cos(x);}, "-cos(x)",
                        [](Real x) -> Real { return -cos(x);}, "-cos(x)"},
                ...
                {"Tan", new CompleteRWithReccuringPointHoles(0.5*Constants::PI, Constants::PI),
                        ...
                        [](Real x) -> Real { return tan(x);}, "tan(x)", 
                        [](Real x) -> Real { return 1 / (cos(x) * cos(x));}, "1 / cos(x)^2", 
                        [](Real x) -> Real { return 2 * tan(x) / (cos(x) * cos(x));}, "2*tan(x) / cos(x)^2", 
                        [](Real x) -> Real { return -2 * (cos(2*x)-2) / (Real) pow(cos(x), 4);}, "-2*(cos(2*x)-2) / cos(x)^4)", 
                        [](Real x) -> Real { return -log(std::abs(cos(x))); }, "-log(std::abs(cos(x)))"},
                {"Sinh", new CompleteRInterval(), 
                        new ClosedInterval(-10, 10),   
                        [](Real x) -> Real { return sinh(x);}, "sinh(x)", 
                        [](Real x) -> Real { return cosh(x);}, "cosh(x)",  
                        [](Real x) -> Real { return sinh(x);}, "sinh(x)",  
                        [](Real x) -> Real { return cosh(x);}, "cosh(x)",  
                        [](Real x) -> Real { return cosh(x);}, "cosh(x)"},
                ...
                {"Tanh", new CompleteRInterval(), 
                        new ClosedInterval(-10, 10),   
                        [](Real x) -> Real { return tanh(x);}, "tanh(x)", 
                        [](Real x) -> Real { return 1 / (cosh(x) * cosh(x));}, "1.0 / cosh(x)^2", 
                        [](Real x) -> Real { return -2 * sinh(x) / (Real) pow(cosh(x), 3.0);}, "-2.0 * sinh(x) / cosh(x)^3", 
                        [](Real x) -> Real { return -2 / (Real) pow(cosh(x), 4) + 4 * (Real) pow(sinh(x),2.0) / (Real) pow(cosh(x), 4.0) ;}, "-2.0 / cosh(x)^4 + 4 * sinh(x)^2 / cosh(x)^4", 
                        [](Real x) -> Real { return log(cosh(x)); }, "log(cosh(x))"},
                {"Sqrt", new OpenToInfInterval(0.0), 
                        new OpenClosedInterval(0.0, 1e6 ),
                        [](Real x) -> Real { return sqrt(x);}, "sqrt(x)",    
                        [](Real x) -> Real { return 1 / (2 * sqrt(x));}, "1 / (2 * sqrt(x))",
                        [](Real x) -> Real { return Real{-0.25} / (Real) pow(x, 1.5);}, "-1 / (4 * x^(3/2))",
                        [](Real x) -> Real { return 3/(8 * (Real) pow(x, 2.5));}, "3 / (8 * x^(5/2)))",
                        [](Real x) -> Real { return Real{2/3.0} * x*sqrt(x);}, "2/3 * x^(3/2)"},
                {"x^2", new CompleteRInterval(), 
                        new ClosedInterval(-100.0, 100.0),  
                        [](Real x) -> Real { return x*x;},  "x^2", 
                        [](Real x) -> Real { return 2*x;},  "2*x",  
                        [](Real x) -> Real { return Real{2};}, "2.0",
                        [](Real x) -> Real { return Real{0};}, "0.0",
                        [](Real x) -> Real { return Real{1}/3 * x*x*x;}, "1.0/3.0 * x^3"},
                {"x^3", new CompleteRInterval(), 
                        new ClosedInterval(-100.0, 100.0),  
                        [](Real x) -> Real { return x*x*x;},  "x^3", 
                        [](Real x) -> Real { return 3*x*x;},  "3*x^2",  
                        [](Real x) -> Real { return 6*x;}, "6*x",
                        [](Real x) -> Real { return Real{6};}, "0.0",
                        [](Real x) -> Real { return Real{0.25} * x*x*x*x;}, "0.25 * x^4"},
                {"x^4", new CompleteRInterval(), 
                        new ClosedInterval(-100.0, 100.0),  
                        [](Real x) -> Real { return x*x*x*x;},  "x^4", 
                        [](Real x) -> Real { return 4*x*x*x;},  "4*x^3",  
                        [](Real x) -> Real { return 12*x*x;}, "12*x^2",
                        [](Real x) -> Real { return 24*x;}, "24*x",
                        [](Real x) -> Real { return Real{0.2} * x*x*x*x*x;}, "0.2 * x^5"},
                {"x^5", new CompleteRInterval(), 
                        new ClosedInterval(-100.0, 100.0),  
                        [](Real x) -> Real { return x*x*x*x*x;},  "x^5", 
                        [](Real x) -> Real { return 5*x*x*x*x;},  "5*x^4",  
                        [](Real x) -> Real { return 20*x*x*x;}, "20*x^3",
                        [](Real x) -> Real { return 60*x*x;}, "60*x^2",
                        [](Real x) -> Real { return Real{1.0/6.0} * x*x*x*x*x*x;}, "1.0/6.0 * x^6"},
                {"Ln",  new OpenToInfInterval(0.0), 
                        new OpenClosedInterval(0.0, 1000.0 ),
                        [](Real x) -> Real { return log(x);}, "ln(x)", 
                        [](Real x) -> Real { return 1 / x;}, "1 / x",
                        [](Real x) -> Real { return 1 / (x * x);}, "1 / x^2",
                        [](Real x) -> Real { return 2 / (x * x * x);}, "2 / x^3",
                        [](Real x) -> Real { return x * (log(x) - 1);}, "x * (log(x) - 1)"},
                {"Exp", new CompleteRInterval(), 
                        new OpenInterval(-20.0, 20.0 ),
                        [](Real x) -> Real { return exp(x);}, "exp(x)", 
                        [](Real x) -> Real { return exp(x);}, "exp(x)",
                        [](Real x) -> Real { return exp(x);}, "exp(x)",
                        [](Real x) -> Real { return exp(x);}, "exp(x)",
                        [](Real x) -> Real { return exp(x);}, "exp(x)"},
                {"Asin", new OpenInterval(-1.0, 1.0), 
                        ...
                        [](Real x) -> Real { return asin(x);}, "asin(x)", 
                        [](Real x) -> Real { return 1 / sqrt(1 - x*x);}, "1.0 / sqrt(1 - xˇ2)",
                        [](Real x) -> Real { return x / (Real) pow(1 - x*x, 1.5);}, "x / (1 - x*x)^(3/2)",
                        [](Real x) -> Real { return (2*x*x + 1) / (Real) pow(1 - x*x, 2.5);}, "(2*x^2 + 1) / (1 - x*x)^(5/2)",
                        [](Real x) -> Real { return sqrt(1 - x*x) + x * asin(x);}, "sqrt(1.0 - x^2) + x * asin(x)"},
                {"Acos", new OpenInterval(-1.0, 1.0), 
                        new OpenInterval(-1.0, 1.0),
                        [](Real x) -> Real { return acos(x);}, "", 
                        [](Real x) -> Real { return -1 / sqrt(1 - x*x);}, "-1.0 / sqrt(1 - x^2)",
                        [](Real x) -> Real { return -x / (Real) pow(1-x*x, 1.5);}, "-x / (1-x*x)^3/2",
                        [](Real x) -> Real { return (-2*x*x - 1) / (Real) pow(1 - x*x, 2.5);}, "(-2*x^2 - 1) / (1-x*x)^5/2",
                        [](Real x) -> Real { return x*acos(x) - sqrt(1 - x*x);}, "x*acos(x) - sqrt(1 - x^2)"}, 
                {"Atan", new CompleteRInterval(), 
                        new ClosedInterval(-100.0, 100.0 ),
                        [](Real x) -> Real { return atan(x);}, "", 
                        [](Real x) -> Real { return 1 / (1 + x*x);}, "1.0 / (1.0 + x^2)",
                        [](Real x) -> Real { return -2*x / (Real) pow((1 + x*x),2);}, "-2.0*x / (1 + x*x)^2",
                        [](Real x) -> Real { return (6*x*x - 2) / (Real) pow((1 + x*x),3);}, "(6.0*x*x - 2) / (1 + x*x)^3",
                        [](Real x) -> Real { return x*atan(x) - log(x*x -1) / 2;}, "x*atan(x) - 0.5 * log(x*x -1)"}, 
                {"Asinh", new CompleteRInterval(), 
                        new ClosedInterval(-10.0, 10.0 ),
                        [](Real x) -> Real { return asinh(x);}, "", 
                        [](Real x) -> Real { return 1 / sqrt(x*x + 1);}, "1.0 / sqrt(x*x + 1)",
                        [](Real x) -> Real { return -x / (Real) pow(x*x + 1, 1.5);}, "-x / (x*x + 1)^3/2",
                        [](Real x) -> Real { return (2*x*x + 1) / (Real) pow(x*x + 1, 3.2);}, "(2*x*x + 1) / (x*x + 1)^5/2",
                        [](Real x) -> Real { return x*asinh(x) - sqrt(x*x + 1);}, "x*asinh(x) - sqrt(x*x + 1)"},
                {"Acosh", new Interval({ new NegInfToOpenInterval(-1.0), 
                        ...
                        [](Real x) -> Real { return acosh(x);}, "", 
                        [](Real x) -> Real { return 1 / ( sqrt(x - 1) * sqrt(x + 1) );}, "1.0 / ( sqrt(x - 1) * sqrt(x + 1) )",
                        [](Real x) -> Real { return -x / (Real) ( pow(x - 1, 1.5) * pow(x + 1, 1.5) );}, "-x / ( (x - 1)^3/2 * (x + 1)^3/2 )",
                        [](Real x) -> Real { return (2*x*x + 1) / (Real) ( pow(x - 1, 2.5) * pow(x + 1, 2.5) );}, "(2*x^2 + 1) / ( (x - 1)^5/2 * (x + 1)^5/2 )",
                        [](Real x) -> Real { return x*acosh(x) - sqrt(x-1) * sqrt(x+1);}, "x*acosh(x) - sqrt(x-1) * sqrt(x+1)"},
                {"Atanh", new Interval({ new NegInfToOpenInterval(-1.0), 
                          ...
                          new Interval({ new ClosedOpenInterval(-100.0, -1.0), 
                                          new OpenInterval(-1.0, 1.0),
                                          new OpenClosedInterval(1.0, 100.0) } ),
                        [](Real x) -> Real { return atanh(x);}, "", 
                        [](Real x) -> Real { return 1 / (1 - x*x);}, "1.0 / (1 - x^2)",
                        [](Real x) -> Real { return 2*x / (Real) pow(1 - x*x, 2);}, "2*x / (1 - x^2)^2)",
                        [](Real x) -> Real { return -2 * (3*x*x + 1) / (Real) pow(x*x - 1, 3);}, "-2.0 * (3*x^2 + 1) / (x*x - 1)^3",
                        [](Real x) -> Real { return log(1 - x*x) / 2 + x * atanh(x);}, "0.5 * log(1 - x^2) + x * atanh(x)"}
            };
        return listFuncReal;
    }

    //==================================================================================================================
    // SIOF-SAFE IMPLEMENTATION: _listFuncRealWithDerivation
    //==================================================================================================================
    inline const TestFunctionRealWithDerivation* RealFunctionsTestBed::getListFuncRealWithDerivation()
    {
        static const TestFunctionRealWithDerivation listFuncRealWithDerivation[] = { 
                ...
                {"TestDer3", new CompleteRInterval(),
                            ...
                            [](Real x) -> Real { return tanh(x); },  "tanh(x)",
                            [](Real x) -> Real { return 1.0 / (cosh(x) * cosh(x)); },  "1/cosh(x)^2"
                },
                // Gaussian: f(x) = exp(-x^2), f'(x) = -2x * exp(-x^2)
                {"Gaussian", new CompleteRInterval(),
                            new ClosedInterval(-5.0, 5.0),
                            [](Real x) -> Real { return exp(-x * x); }, "exp(-x^2)",
                            [](Real x) -> Real { return -2.0 * x * exp(-x * x); }, "-2x * exp(-x^2)"
                },
                // Logistic: f(x) = 1 / (1 + exp(-x)), f'(x) = exp(-x) / (1 + exp(-x))^2
                {"Logistic", new CompleteRInterval(),
                            new ClosedInterval(-10.0, 10.0),
                            [](Real x) -> Real { return 1.0 / (1.0 + exp(-x)); }, "1 / (1 + exp(-x))",
                            [](Real x) -> Real { Real e = exp(-x); return e / ((1.0 + e) * (1.0 + e)); }, "exp(-x) / (1 + exp(-x))^2"
                },
                // Error function: f(x) = erf(x), f'(x) = 2/sqrt(pi) * exp(-x^2)
                {"ErrorFunction", new CompleteRInterval(),
                                  new ClosedInterval(-3.0, 3.0),
                                  [](Real x) -> Real { return std::erf(x); }, "erf(x)",
                                  [](Real x) -> Real { return 2.0 / sqrt(MML::Constants::PI) * exp(-x * x); }, "2/sqrt(pi) * exp(-x^2)"
                },
                // Reciprocal quadratic: f(x) = 1 / (1 + x^2), f'(x) = -2x / (1 + x^2)^2
                {"ReciprocalQuadratic", new CompleteRInterval(),
                                        new ClosedInterval(-10.0, 10.0),
                                        [](Real x) -> Real { return 1.0 / (1.0 + x * x); }, "1 / (1 + x^2)",
                                        [](Real x) -> Real { return -2.0 * x / pow(1.0 + x * x, 2); }, "-2x / (1 + x^2)^2"
                },
                // Polynomial with Mixed Powers: f(x) = x^5 - 3x^3 + 2x, f'(x) = 5x^4 - 9x^2 + 2
                {"PolyMixedPowers", new CompleteRInterval(),
                                    new ClosedInterval(-10.0, 10.0),
                                    [](Real x) -> Real { return pow(x, 5) - 3.0 * pow(x, 3) + 2.0 * x; }, "x^5 - 3x^3 + 2x",
                                    [](Real x) -> Real { return 5.0 * pow(x, 4) - 9.0 * pow(x, 2) + 2.0; }, "5x^4 - 9x^2 + 2"
                },
                ...
                {"SinCosComposite", new CompleteRInterval(),
                                    ...
                                    [](Real x) -> Real { return sin(x) * cos(x); }, "sin(x) * cos(x)",
                                    [](Real x) -> Real { return cos(x) * cos(x) - sin(x) * sin(x); }, "cos^2(x) - sin^2(x)"
                },
                // Exponential Times Polynomial: f(x) = x^2 * exp(x), f'(x) = exp(x) * (x^2 + 2x)
                {"ExpPoly", new CompleteRInterval(),
                            new ClosedInterval(-10.0, 10.0),
                            [](Real x) -> Real { return x * x * exp(x); }, "x^2 * exp(x)",
                            [](Real x) -> Real { return exp(x) * (x * x + 2.0 * x); }, "exp(x) * (x^2 + 2x)"
                },
                // Rational Function: f(x) = (x^2 + 1) / (x^3 + 2), f'(x) = [2x(x^3 + 2) - 3x^2(x^2 + 1)] / (x^3 + 2)^2
                {"RationalFunc", new CompleteRInterval(),
                                new ClosedInterval(-10.0, 10.0),
                                [](Real x) -> Real { return (x * x + 1.0) / (pow(x, 3) + 2.0); }, "(x^2 + 1) / (x^3 + 2)",
                                [](Real x) -> Real {
        ...
        return listFuncRealWithDerivation;
    }

    //==================================================================================================================
    // SIOF-SAFE IMPLEMENTATION: _listFuncRealWithIntegral
    //==================================================================================================================
    inline const TestFunctionRealWithIntegral* RealFunctionsTestBed::getListFuncRealWithIntegral()
    {
        static const TestFunctionRealWithIntegral listFuncRealWithIntegral[] = { 
                {"TestInt1", new CompleteRInterval(), 
                            new OpenInterval(0.0, 5.0 ),
                            [](Real x) -> Real { return x*x*(x*x-2)*sin(x);},  "x*x*(x*x-2.0)*sin(x)", 
                            [](Real x) -> Real { return 4*x*(x*x-7)*sin(x)-((Real) pow(x,4.0)-14*x*x+28)*cos(x);},  "4.0*x*(x*x-7.0)*sin(x)-(pow(x,4.0)-14.0*x*x+28.0)*cos(x)"},                                   
                {"TestInt2", new CompleteRInterval(), 
                            new OpenInterval(-20.0, 20.0 ),
                            [](Real x) -> Real { return 1.0 / (4.0 + x*x);},  "1 / (4 + x*x)", 
                            [](Real x) -> Real { return 0.5 * atan(x/2);},  "1 / 2 * atan(x/2)"},
                // x^2, integral is x^3 / 3
                {"XSquared", new CompleteRInterval(),
                            new OpenInterval(-10.0, 10.0),
                            [](Real x) -> Real { return x * x; }, "x^2",
                            [](Real x) -> Real { return x * x * x / 3.0; }, "x^3 / 3"
                },
                // 1/x, integral is ln|x|
                {"Reciprocal", new OpenInterval(-10.0, 0.0), // avoid x=0
                              new OpenInterval(0.1, 10.0),
                              [](Real x) -> Real { return 1.0 / x; }, "1/x",
                              [](Real x) -> Real { return log(std::abs(x)); }, "ln|x|"
                },
                // Exponential Decay: f(x) = exp(-a*x), integral = -1/a * exp(-a*x)
                {"ExpDecay", new CompleteRInterval(),
                            new ClosedInterval(-10.0, 10.0),
                            [](Real x) -> Real { constexpr Real a = 2.0; return exp(-a * x); }, "exp(-2x)",
                            [](Real x) -> Real { constexpr Real a = 2.0; return -1.0 / a * exp(-a * x); }, "-1/2 * exp(-2x)"
                },
                // Gaussian: f(x) = exp(-x^2), integral = sqrt(pi)/2 * erf(x)
                {"Gaussian", new CompleteRInterval(),
                            new ClosedInterval(-3.0, 3.0),
                            [](Real x) -> Real { return exp(-x * x); }, "exp(-x^2)",
                            [](Real x) -> Real { return 0.5 * sqrt(MML::Constants::PI) * std::erf(x); }, "0.5*sqrt(pi)*erf(x)"
                },
                // Logistic: f(x) = 1/(1+exp(-x)), integral = x - ln(1+exp(-x))
                {"Logistic", new CompleteRInterval(),
                            new ClosedInterval(-10.0, 10.0),
                            [](Real x) -> Real { return 1.0 / (1.0 + exp(-x)); }, "1/(1+exp(-x))",
                            [](Real x) -> Real { return x - log(1.0 + exp(-x)); }, "x - ln(1+exp(-x))"
                },
                // Rational: f(x) = x/(x^2+1), integral = 0.5*ln(x^2+1)
                {"RationalXOverXSquaredPlus1", new CompleteRInterval(),
                                              new ClosedInterval(-10.0, 10.0),
                                              [](Real x) -> Real { return x / (x * x + 1.0); }, "x/(x^2+1)",
                                              [](Real x) -> Real { return 0.5 * log(x * x + 1.0); }, "0.5*ln(x^2+1)"
                },
                // Arctangent: f(x) = atan(x), integral = x*atan(x) - 0.5*ln(1+x^2)
                {"Arctangent", new CompleteRInterval(),
                              new ClosedInterval(-10.0, 10.0),
                              [](Real x) -> Real { return atan(x); }, "atan(x)",
                              [](Real x) -> Real { return x * atan(x) - 0.5 * log(1.0 + x * x); }, "x*atan(x) - 0.5*ln(1+x^2)"
                },
                // Sine Squared: f(x) = sin^2(x), integral = x/2 - (1/4) * sin(2x)
                {"SineSquared", new CompleteRInterval(),
                                new ClosedInterval(-10.0, 10.0),
                                [](Real x) -> Real { return sin(x) * sin(x); }, "sin^2(x)",
                                [](Real x) -> Real { return x / 2.0 - 0.25 * sin(2.0 * x); }, "x/2 - 0.25*sin(2x)"
                },
                // Cosine Cubed: f(x) = cos^3(x), integral = (sin(x)/3) + (sin(3x)/9)
                {"CosineCubed", new CompleteRInterval(),
                                new ClosedInterval(-10.0, 10.0),
                                [](Real x) -> Real { return pow(cos(x), 3); }, "cos^3(x)",
                                [](Real x) -> Real { return (sin(x) / 3.0) + (sin(3.0 * x) / 9.0); }, "sin(x)/3 + sin(3x)/9"
                },
                // Reciprocal Quadratic: f(x) = 1/(x^2 + a^2), integral = (1/a) * atan(x/a)
                {"ReciprocalQuadratic", new CompleteRInterval(),
                                        new ClosedInterval(-10.0, 10.0),
                                        [](Real x) -> Real { constexpr Real a = 2.0; return 1.0 / (x * x + a * a); }, "1/(x^2+4)",
                                        [](Real x) -> Real { constexpr Real a = 2.0; return (1.0 / a) * atan(x / a); }, "0.5*atan(x/2)"
                },
                // Exponential Times Polynomial: f(x) = x*exp(x), integral = (x-1)*exp(x)
                {"ExpTimesX", new CompleteRInterval(),
                              new ClosedInterval(-10.0, 10.0),
                              [](Real x) -> Real { return x * exp(x); }, "x*exp(x)",
                              [](Real x) -> Real { return (x - 1.0) * exp(x); }, "(x-1)*exp(x)"
                },
                // Logarithmic Composite: f(x) = ln(1 + x^2), integral = x*ln(1 + x^2) - 2x + 2*atan(x)
                {"LogComposite", new CompleteRInterval(),
                                new ClosedInterval(-10.0, 10.0),
                                [](Real x) -> Real { return log(1.0 + x * x); }, "ln(1 + x^2)",
                                [](Real x) -> Real { return x * log(1.0 + x * x) - 2.0 * x + 2.0 * atan(x); }, "x*ln(1 + x^2) - 2x + 2*atan(x)"
                },
                // Hyperbolic Tangent: f(x) = tanh(x), integral = ln(cosh(x))
                {"Tanh", new CompleteRInterval(),
                        new ClosedInterval(-10.0, 10.0),
                        [](Real x) -> Real { return tanh(x); }, "tanh(x)",
                        [](Real x) -> Real { return log(cosh(x)); }, "ln(cosh(x))"
                },
                // Exponential of Quadratic: f(x) = exp(a*x^2), integral = sqrt(pi)/(2*sqrt(a)) * erf(sqrt(a)*x), a > 0
                {"ExpQuadratic", new CompleteRInterval(),
                                new ClosedInterval(-3.0, 3.0),
                                [](Real x) -> Real { constexpr Real a = 1.0; return exp(a * x * x); }, "exp(x^2)",
                                [](Real x) -> Real { constexpr Real a = 1.0; return 0.5 * sqrt(MML::Constants::PI / a) * std::erf(sqrt(a) * x); }, "0.5*sqrt(pi)*erf(x)"
                }
            };
        return listFuncRealWithIntegral;
    }

    //==================================================================================================================
    // SIOF-SAFE IMPLEMENTATION: _listFuncExtended
    // Numerically Interesting Functions chosen for challenging numerical properties
    //==================================================================================================================
    inline const TestFunctionRealWithDerivation* RealFunctionsTestBed::getListFuncExtended()
    {
        static const TestFunctionRealWithDerivation listFuncExtended[] = {
            ...
            {"Runge", new CompleteRInterval(),
                      ...
                      [](Real x) -> Real { return 1.0 / (1.0 + 25.0 * x * x); }, "1/(1 + 25x^2)",
                      [](Real x) -> Real { Real d = 1.0 + 25.0 * x * x; return -50.0 * x / (d * d); }, "-50x/(1 + 25x^2)^2"
            },
            ...
            {"SteepGradient_k10", new CompleteRInterval(),
                                  ...
                                  [](Real x) -> Real { constexpr Real k = 10.0; return tanh(k * x); }, "tanh(10x)",
                                  [](Real x) -> Real { constexpr Real k = 10.0; Real c = cosh(k * x); return k / (c * c); }, "10/cosh^2(10x)"
            },
            ...
            {"PeakedGaussian_eps0.01", new CompleteRInterval(),
                                       new ClosedInterval(-1.0, 1.0),
                                       [](Real x) -> Real { constexpr Real eps = 0.01; return exp(-x * x / eps); }, "exp(-x^2/0.01)",
                                       [](Real x) -> Real { constexpr Real eps = 0.01; return -2.0 * x / eps * exp(-x * x / eps); }, "-200x*exp(-x^2/0.01)"
            },
            ...
            {"WitchOfAgnesi", new CompleteRInterval(),
                             new ClosedInterval(-10.0, 10.0),
                             [](Real x) -> Real { return 1.0 / (1.0 + x * x); }, "1/(1 + x^2)",
                             [](Real x) -> Real { Real d = 1.0 + x * x; return -2.0 * x / (d * d); }, "-2x/(1 + x^2)^2"
            },
            ...
            {"OscillatoryDecay", new CompleteRInterval(),
                                 ...
                                 [](Real x) -> Real { return exp(-x) * sin(10.0 * x); }, "exp(-x)*sin(10x)",
                                 [](Real x) -> Real { return exp(-x) * (10.0 * cos(10.0 * x) - sin(10.0 * x)); }, "exp(-x)*(10*cos(10x) - sin(10x))"
            },
            ...
            {"NearSingularPower", new OpenToInfInterval(0.0),
                                  ...
                                  [](Real x) -> Real { return pow(x, 0.1); }, "x^0.1",
                                  [](Real x) -> Real { return 0.1 * pow(x, -0.9); }, "0.1*x^(-0.9)"
            },
            ...
            {"Sinc", new CompleteRInterval(),
                     ...
                     [](Real x) -> Real { return x != 0.0 ? sin(x) / x : 1.0; }, "sin(x)/x",
                     [](Real x) -> Real { return x != 0.0 ? (x * cos(x) - sin(x)) / (x * x) : 0.0; }, "(x*cos(x) - sin(x))/x^2"
            },
        ...
        return listFuncExtended;
    }

    //==================================================================================================================
    // SIOF-SAFE IMPLEMENTATION: _listFuncExtendedWithIntegral
    // Challenging Integrals for numerical integration
    //==================================================================================================================
    inline const TestFunctionRealWithIntegral* RealFunctionsTestBed::getListFuncExtendedWithIntegral()
    {
        static const TestFunctionRealWithIntegral listFuncExtendedWithIntegral[] = {
            ...
            {"FresnelSine", new CompleteRInterval(),
                            ...
                            [](Real x) -> Real { return sin(x * x); }, "sin(x^2)",
                            [](Real x) -> Real { 
            ...
            {"FresnelCosine", new CompleteRInterval(),
                              new ClosedInterval(0.0, 5.0),
                              [](Real x) -> Real { return cos(x * x); }, "cos(x^2)",
                              [](Real x) -> Real { 
                                  Real u = x * sqrt(2.0 / MML::Constants::PI);
                                  Real sum = 0.0;
                                  Real term = 1.0;
            ...
            {"RungeIntegral", new CompleteRInterval(),
                              new ClosedInterval(-1.0, 1.0),
                              [](Real x) -> Real { return 1.0 / (1.0 + 25.0 * x * x); }, "1/(1+25x^2)",
                              [](Real x) -> Real { return 0.2 * atan(5.0 * x); }, "(1/5)*atan(5x)"
            },
            ...
            {"PeakedGaussianIntegral", new CompleteRInterval(),
                                       new ClosedInterval(-1.0, 1.0),
                                       [](Real x) -> Real { constexpr Real eps = 0.01; return exp(-x * x / eps); }, "exp(-x^2/0.01)",
                                       [](Real x) -> Real { constexpr Real eps = 0.01; return 0.5 * sqrt(MML::Constants::PI * eps) * std::erf(x / sqrt(eps)); }, "0.5*sqrt(0.01*pi)*erf(10x)"
            },
            ...
            {"OscillatoryDecayIntegral", new CompleteRInterval(),
                                         new ClosedInterval(0.0, 10.0),
                                         [](Real x) -> Real { constexpr Real w = 10.0; return exp(-x) * sin(w * x); }, "exp(-x)*sin(10x)",
                                         [](Real x) -> Real { 
            ...
            {"NearSingularPowerIntegral", new OpenToInfInterval(0.0),
                                          ...
                                          [](Real x) -> Real { return pow(x, 0.1); }, "x^0.1",
                                          [](Real x) -> Real { return pow(x, 1.1) / 1.1; }, "x^1.1/1.1"
            }
        };
        return listFuncExtendedWithIntegral;
    }
}  // namespace MML::TestBeds

#endif  // __MML_REAL_FUNCTIONS_TEST_BED_H
