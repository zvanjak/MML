...
namespace MML::TestBeds
{
    ...
    public:
        ...
        const static TestFunctionVector<3>& getTestFunctionVector(int i)  { return getListFuncVector3()[i]; }

        const static TestFunctionVector<3>& getTestFunctionVector(const std::string &funcName)
        {
            const auto& funcs = getListFuncVector3();
    ...
    private:
        ...
        static const TestFunctionVector<3>* getListFuncVector3();
    };

    // SIOF-SAFE IMPLEMENTATION
    inline const TestFunctionVector<3>* VectorFunctionsTestBed::getListFuncVector3()
    {
        static const TestFunctionVector<3> listFuncVector3[] = {
