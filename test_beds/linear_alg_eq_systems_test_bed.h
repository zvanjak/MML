...
namespace MML::TestBeds
{
    ...
    public:
        ...
        TestLinearSystem(int n, const Matrix<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol, const Vector<Complex> &eigen_values) : 
            _n(n), _mat(mat), _rhs(rhs), _sol(sol), _eigen_values(eigen_values), _rank(n)
        {}
        TestLinearSystem(int n, const Matrix<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol, const Vector<Complex> &eigen_values, const std::vector<Vector<Complex>> &eigen_vectors) : 
        ...
        TestLinearSystem(int n, const Matrix<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol, 
                        const Vector<Complex> &eigen_values, Real determinant, const Vector<Real> &singular_values, Real cond_2, int rank) : 
        ...
        {}
        TestLinearSystem(int n, const Matrix<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol, 
                        const Vector<Complex> &eigen_values, const std::vector<Vector<Complex>> &eigen_vectors,
                        Real determinant, const Vector<Real> &singular_values, Real cond_2, int rank) : 
    ...
    public:
        ...
        TestLinearSystemMultiRHS(int n, const Matrix<Real> &mat, const Matrix<Real> &rhs, const Matrix<Real> &sol) : 
    ...
    public:
        ...
        // Original constructors (backward compatible)
        TestLinearSystemSymmetric(int n, const MatrixSym<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol, const Vector<Real> &eigen_values) : 
            _n(n), _mat(mat), _rhs(rhs), _sol(sol), _eigen_values(eigen_values), _rank(n)
        {}
        TestLinearSystemSymmetric(int n, const MatrixSym<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol, const Vector<Real> &eigen_values, const std::vector<Vector<Real>> &eigen_vectors) : 
            _n(n), _mat(mat), _rhs(rhs), _sol(sol), _eigen_values(eigen_values), _eigen_vectors(eigen_vectors), _rank(n)
        {}
        
        // Extended constructor with matrix properties
        TestLinearSystemSymmetric(int n, const MatrixSym<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol, 
                                  const Vector<Real> &eigen_values, Real determinant, const Vector<Real> &singular_values, Real cond_2, int rank) : 
            _n(n), _mat(mat), _rhs(rhs), _sol(sol), _eigen_values(eigen_values),
            _determinant(determinant), _singular_values(singular_values), _cond_2(cond_2), _rank(rank)
        {}
    };
    ...
    public:
        ...
        TestLinearSystemComplex(int n, const Matrix<Complex> &mat, const Vector<Complex> &rhs, const Vector<Complex> &sol) : 
            _n(n), _m(n), _mat(mat), _rhs(rhs), _sol(sol), _rank(n)
        {}
        
        TestLinearSystemComplex(int n, const Matrix<Complex> &mat, const Vector<Complex> &rhs, const Vector<Complex> &sol,
                               Real det_abs, const Vector<Real> &singular_values, Real cond_2, int rank) : 
    ...
    public:
        ...
        TestLinearSystemOverdetermined(int m, int n, const Matrix<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol) : 
            _m(m), _n(n), _mat(mat), _rhs(rhs), _sol(sol), _rank(n)
        {}
        
        TestLinearSystemOverdetermined(int m, int n, const Matrix<Real> &mat, const Vector<Real> &rhs, const Vector<Real> &sol,
                                       const Vector<Real> &singular_values, Real cond_2, int rank) : 
