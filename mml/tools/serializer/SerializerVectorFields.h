...
///                                                                                   ///
///  File:        serializer/SerializerVectorFields.h                                 ///
...
///                                                                                   ///
///////////////////////////////////////////////////////////////////////////////////////////
#if !defined MML_SERIALIZER_VECTOR_FIELDS_H
#define MML_SERIALIZER_VECTOR_FIELDS_H
...
namespace MML
{
	namespace Serializer
	{
		...
		{
			return SaveVectorFunc2D(f, FormatType::VECTOR_FIELD_2D_CARTESIAN, title, x1, x2, numPointsX, y1, y2, numPointsY, fileName);
		}
		...
		{
			return SaveVectorFunc2D(f, FormatType::VECTOR_FIELD_2D_CARTESIAN, title, x1, x2, numPointsX, y1, y2, numPointsY, fileName, upper_threshold);
		}
		...
		{
			return SaveVectorFunc3D(f, FormatType::VECTOR_FIELD_3D_CARTESIAN, title, x1, x2, numPointsX, y1, y2, numPointsY, z1, z2, numPointsZ, fileName);
		}
		...
		inline SerializeResult SaveVectorFunc3DCartesian(const IVectorFunction<3>& f, std::string title, 
		                                                 ...
		                                                 Real upper_threshold)
		{
			return SaveVectorFunc3D(f, FormatType::VECTOR_FIELD_3D_CARTESIAN, title, x1, x2, numPointsX, y1, y2, numPointsY, z1, z2, numPointsZ, fileName, upper_threshold);
		}
		...
		{
			return SaveVectorFunc3D(f, FormatType::VECTOR_FIELD_SPHERICAL, title, r1, r2, numPointsR, theta1, theta2, numPointsTheta, phi1, phi2, numPointsPhi, fileName);
		}
		...
		inline SerializeResult SaveVectorFuncSpherical(const IVectorFunction<3>& f, std::string title, 
		                                               ...
		                                               std::string fileName, Real upper_threshold)
		{
			return SaveVectorFunc3D(f, FormatType::VECTOR_FIELD_SPHERICAL, title, r1, r2, numPointsR, theta1, theta2, numPointsTheta, phi1, phi2, numPointsPhi, fileName, upper_threshold);
		}

	} // namespace Serializer
} // namespace MML

#endif // MML_SERIALIZER_VECTOR_FIELDS_H
