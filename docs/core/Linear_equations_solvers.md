...
Solving linear system by performing LU decomposition.
...
Solving linear system by performing Singular Value Decomposition (SVD) of the matrix.
...
Solving linear system by performing Cholesky decomposition of the matrix.
System matrix must be positive definite.
