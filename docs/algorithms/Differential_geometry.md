...
Set of algorithms for differential geometry.
Right now, it contains only algorithms for calculating differential geometry proiperties of parametric curves.
With the use of ParametricCurveAnalyzer class, you can calculate tangent, normal, binormal, curvature, curvature vector and torsion.
