...
namespace MML::Tests::Core::DerivationParametricCurveTests {
...
TEST_CASE("Parametric curve - Test bed curves first derivatives", "[parametric_curve][derivative][testbed]")
{
    ...
    // Test with Circle3DXYCurve from test bed
    auto circle = ParametricCurvesTestBed::getTestCurve("Circle3DXYCurve");
    t = Constants::PI / 3;
