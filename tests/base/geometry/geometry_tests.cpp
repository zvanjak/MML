...
namespace MML::Tests::Base::GeometryTests
{
	...
	TEST_CASE("Point2Polar::TransfToCartesian", "[Point2Polar]")
	{
		...
		REQUIRE_THAT(cart.X(), RealWithinRel(REAL(3.0) * cos(MML::Constants::PI / 6), TOL(1e-14, 1e-5)));
		REQUIRE_THAT(cart.Y(), RealWithinRel(REAL(3.0) * sin(MML::Constants::PI / 6), TOL(1e-14, 1e-5)));
	}
	...
	{
		Point2Cartesian a(REAL(1.0), REAL(2.0));
		Point2Cartesian b(REAL(1.0) + TOL3(1e-12, 1e-7, 1e-16), REAL(2.0) + TOL3(1e-12, 1e-7, 1e-16));
	...
	TEST_CASE("Point2Cartesian::op-", "[Point2Cartesian]")
	{
		...
		Point2Cartesian c = a - b;
		REQUIRE_THAT(c.X(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(c.Y(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point2Cartesian::CompoundAssignment", "[Point2Cartesian]")
	{
		...
		REQUIRE_THAT(p.X(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Y(), RealWithinAbs(REAL(6.0), TOL(1e-10, 1e-5)));
		
		p -= Point2Cartesian(REAL(1.0), REAL(1.0));
		REQUIRE_THAT(p.X(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Y(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		
		p *= REAL(2.0);
		REQUIRE_THAT(p.X(), RealWithinAbs(REAL(6.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Y(), RealWithinAbs(REAL(10.0), TOL(1e-10, 1e-5)));
	...
	{
		Point2Polar a(REAL(2.0), REAL(0.5));
		Point2Polar b(REAL(2.0) + TOL(1e-12, 1e-5), REAL(0.5));
	...
	TEST_CASE("Point2Polar::RoundTrip", "[Point2Polar]")
	{
		...
		REQUIRE_THAT(back.X(), RealWithinAbs(original.X(), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(back.Y(), RealWithinAbs(original.Y(), TOL(1e-10, 1e-5)));
	}
	...
	{
		Point3Cartesian a(REAL(1.0), REAL(2.0), REAL(3.0));
		Point3Cartesian b(REAL(1.0) + TOL3(1e-12, 1e-7, 1e-16), REAL(2.0), REAL(3.0));
	...
	TEST_CASE("Point3Cartesian::op-", "[Point3Cartesian]")
	{
		...
		REQUIRE_THAT(c.X(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(c.Y(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(c.Z(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Cartesian::CompoundAssignment", "[Point3Cartesian]")
	{
		...
		REQUIRE_THAT(p.X(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Y(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Z(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
		
		p -= Point3Cartesian(REAL(0.5), REAL(0.5), REAL(0.5));
		REQUIRE_THAT(p.X(), RealWithinAbs(REAL(1.5), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Y(), RealWithinAbs(REAL(2.5), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Z(), RealWithinAbs(REAL(3.5), TOL(1e-10, 1e-5)));
		
		p *= REAL(2.0);
		REQUIRE_THAT(p.X(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Y(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Z(), RealWithinAbs(REAL(7.0), TOL(1e-10, 1e-5)));
	...
	TEST_CASE("Point3Spherical::ParameterConstructor", "[Point3Spherical]")
	{
		...
		REQUIRE_THAT(p.R(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Theta(), RealWithinAbs(Constants::PI / 4, TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Phi(), RealWithinAbs(Constants::PI / 2, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Spherical::FromCartesian", "[Point3Spherical]")
	{
		...
		REQUIRE_THAT(sphZ.R(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(sphZ.Theta(), RealWithinAbs(REAL(0.0), TOL(1e-10, 1e-5)));  // theta=0 at north pole
		
		// Point on x-axis
		Point3Cartesian cartX(REAL(3.0), REAL(0.0), REAL(0.0));
		Point3Spherical sphX(cartX);
		REQUIRE_THAT(sphX.R(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(sphX.Theta(), RealWithinAbs(Constants::PI / 2, TOL(1e-10, 1e-5)));  // on equator
		REQUIRE_THAT(sphX.Phi(), RealWithinAbs(REAL(0.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Spherical::TransfToCart", "[Point3Spherical]")
	{
		...
		REQUIRE_THAT(cart.X(), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(cart.Y(), RealWithinAbs(REAL(0.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(cart.Z(), RealWithinAbs(REAL(0.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Spherical::RoundTrip", "[Point3Spherical]")
	{
		...
		REQUIRE_THAT(back.X(), RealWithinAbs(original.X(), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(back.Y(), RealWithinAbs(original.Y(), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(back.Z(), RealWithinAbs(original.Z(), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Spherical::Dist", "[Point3Spherical]")
	{
		...
		REQUIRE_THAT(a.Dist(a), RealWithinAbs(REAL(0.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(a.Dist(b), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		...
		REQUIRE_THAT(a.Dist(c), RealWithinAbs(std::sqrt(REAL(2.0)), TOL(1e-10, 1e-5)));
		...
		REQUIRE_THAT(e.Dist(f), RealWithinAbs(std::sqrt(REAL(2.0)), TOL(1e-10, 1e-5)));
		...
		REQUIRE_THAT(g.Dist(h), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
		...
		REQUIRE_THAT(s1.Dist(s2), RealWithinAbs(cartDist, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Cylindrical::ParameterConstructor", "[Point3Cylindrical]")
	{
		...
		REQUIRE_THAT(p.R(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Phi(), RealWithinAbs(Constants::PI / 4, TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.Z(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Cylindrical::FromCartesian", "[Point3Cylindrical]")
	{
		...
		REQUIRE_THAT(cyl.R(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));  // sqrt(9+16)
		REQUIRE_THAT(cyl.Z(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Cylindrical::TransfToCart", "[Point3Cylindrical]")
	{
		...
		REQUIRE_THAT(cart.X(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(cart.Y(), RealWithinAbs(REAL(0.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(cart.Z(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Point3Cylindrical::Dist", "[Point3Cylindrical]")
	{
		...
		REQUIRE_THAT(a.Dist(b), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));  // 3-4-5 triangle
	}
	...
	{
		Triangle t(REAL(3.0), REAL(4.0), REAL(5.0));
		REQUIRE_THAT(t.Perimeter(), RealWithinAbs(REAL(12.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(t.Semiperimeter(), RealWithinAbs(REAL(6.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Triangle::Angles", "[Triangle]")
	{
		...
		REQUIRE_THAT(t.AngleC(), RealWithinAbs(Constants::PI / 2, TOL(1e-10, 1e-5)));
		
		// Sum of all angles = π
		Real sum = t.AngleA() + t.AngleB() + t.AngleC();
		REQUIRE_THAT(sum, RealWithinAbs(Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Triangle::Altitudes", "[Triangle]")
	{
		...
		REQUIRE_THAT(t.AltitudeToA(), RealWithinAbs(REAL(2.0) * area / REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(t.AltitudeToB(), RealWithinAbs(REAL(2.0) * area / REAL(4.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(t.AltitudeToC(), RealWithinAbs(REAL(2.0) * area / REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Triangle::Medians", "[Triangle]")
	{
		...
		REQUIRE_THAT(eq.MedianToA(), RealWithinAbs(eq.MedianToB(), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(eq.MedianToB(), RealWithinAbs(eq.MedianToC(), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Triangle::Inradius_Circumradius", "[Triangle]")
	{
		...
		REQUIRE_THAT(t.Inradius(), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
		
		// Circumradius = c/2 = 5/2 = 2.5 for right triangle
		REQUIRE_THAT(t.Circumradius(), RealWithinAbs(REAL(2.5), TOL(1e-10, 1e-5)));
	}
	...
	{
		Circle c(REAL(5.0));
		REQUIRE_THAT(c.Radius(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(c.Diameter(), RealWithinAbs(REAL(10.0), TOL(1e-10, 1e-5)));
		REQUIRE(c.IsValid());
	}
	...
	TEST_CASE("Circle::Area", "[Circle]")
	{
		TEST_PRECISION_INFO();
		Circle c(REAL(2.0));
		REQUIRE_THAT(c.Area(), RealWithinAbs(REAL(4.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Circle::Circumference", "[Circle]")
	{
		TEST_PRECISION_INFO();
		Circle c(REAL(3.0));
		REQUIRE_THAT(c.Circumference(), RealWithinAbs(REAL(6.0) * Constants::PI, TOL(1e-10, 1e-5)));
		REQUIRE_THAT(c.Perimeter(), RealWithinAbs(REAL(6.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Circle::ArcAndSector", "[Circle]")
	{
		...
		REQUIRE_THAT(c.ArcLength(angle), RealWithinAbs(Constants::PI, TOL(1e-10, 1e-5)));  // r*θ = 2*π/2 = π
		REQUIRE_THAT(c.SectorArea(angle), RealWithinAbs(Constants::PI, TOL(1e-10, 1e-5)));  // 0.5*r²*θ = 0.5*4*π/2 = π
	}
	...
	TEST_CASE("Circle::ChordAndSegment", "[Circle]")
	{
		...
		REQUIRE_THAT(c.ChordLength(Constants::PI), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		
		// Segment area for semicircle
		REQUIRE_THAT(c.SegmentArea(Constants::PI), RealWithinAbs(Constants::PI / 2, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Circle::FactoryMethods", "[Circle]")
	{
		...
		REQUIRE_THAT(fromArea.Radius(), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
		
		Circle fromCirc = Circle::FromCircumference(REAL(2.0) * Constants::PI);
		REQUIRE_THAT(fromCirc.Radius(), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Circle::InscribedCircumscribed", "[Circle]")
	{
		...
		REQUIRE_THAT(inscribed.Radius(), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
		
		Circle circumscribed = Circle::Circumscribed(t);
		REQUIRE_THAT(circumscribed.Radius(), RealWithinAbs(REAL(2.5), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Ellipse::ParameterConstructor", "[Ellipse]")
	{
		...
		REQUIRE_THAT(e.SemiMajor(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(e.SemiMinor(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(e.MajorAxis(), RealWithinAbs(REAL(10.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(e.MinorAxis(), RealWithinAbs(REAL(6.0), TOL(1e-10, 1e-5)));
		REQUIRE(e.IsValid());
	}
	...
	TEST_CASE("Ellipse::Area", "[Ellipse]")
	{
		...
		REQUIRE_THAT(e.Area(), RealWithinAbs(REAL(12.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Ellipse::Eccentricity", "[Ellipse]")
	{
		...
		Ellipse circle(REAL(5.0), REAL(5.0));
		REQUIRE_THAT(circle.Eccentricity(), RealWithinAbs(REAL(0.0), TOL(1e-10, 1e-5)));
		
		// e = sqrt(1 - b²/a²) for a=5, b=3: e = sqrt(1 - 9/25) = sqrt(16/25) = 4/5
		Ellipse e(REAL(5.0), REAL(3.0));
		REQUIRE_THAT(e.Eccentricity(), RealWithinAbs(REAL(0.8), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Ellipse::FocalProperties", "[Ellipse]")
	{
		...
		REQUIRE_THAT(e.LinearEccentricity(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(e.FocalDistance(), RealWithinAbs(REAL(8.0), TOL(1e-10, 1e-5)));
		
		// Semi-latus rectum = b²/a = 9/5 = 1.8
		REQUIRE_THAT(e.SemiLatusRectum(), RealWithinAbs(REAL(1.8), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("CircularSector::ParameterConstructor", "[CircularSector]")
	{
		...
		REQUIRE_THAT(s.Radius(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(s.Angle(), RealWithinAbs(Constants::PI / 2, TOL(1e-10, 1e-5)));
		REQUIRE_THAT(s.AngleDegrees(), RealWithinAbs(REAL(90.0), TOL(1e-10, 1e-5)));
		REQUIRE(s.IsValid());
	}
	...
	TEST_CASE("CircularSector::Calculations", "[CircularSector]")
	{
		...
		REQUIRE_THAT(s.Area(), RealWithinAbs(Constants::PI, TOL(1e-10, 1e-5)));
		
		// Arc = r * θ = 2 * π/2 = π
		REQUIRE_THAT(s.ArcLength(), RealWithinAbs(Constants::PI, TOL(1e-10, 1e-5)));
		
		// Perimeter = 2r + arc = 4 + π
		REQUIRE_THAT(s.Perimeter(), RealWithinAbs(REAL(4.0) + Constants::PI, TOL(1e-10, 1e-5)));
		
		// Chord for 90°: 2r*sin(45°) = 2*2*sqrt(2)/2 = 2*sqrt(2)
		REQUIRE_THAT(s.ChordLength(), RealWithinAbs(REAL(2.0) * std::sqrt(REAL(2.0)), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("CircularSegment::Calculations", "[CircularSegment]")
	{
		...
		REQUIRE_THAT(s.Area(), RealWithinAbs(REAL(2.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Arc = r * θ = 2π
		REQUIRE_THAT(s.ArcLength(), RealWithinAbs(REAL(2.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Chord = diameter = 4
		REQUIRE_THAT(s.ChordLength(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
		
		// Sagitta = r(1 - cos(θ/2)) = 2(1 - cos(π/2)) = 2(1 - 0) = 2
		REQUIRE_THAT(s.Sagitta(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("CircularSegment::FromSagitta", "[CircularSegment]")
	{
		...
		REQUIRE_THAT(s.Angle(), RealWithinAbs(Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Annulus::ParameterConstructor", "[Annulus]")
	{
		...
		REQUIRE_THAT(a.InnerRadius(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(a.OuterRadius(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(a.Width(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE(a.IsValid());
	}
	...
	TEST_CASE("Annulus::Area", "[Annulus]")
	{
		...
		REQUIRE_THAT(a.Area(), RealWithinAbs(REAL(12.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Annulus::Circumferences", "[Annulus]")
	{
		...
		REQUIRE_THAT(a.InnerCircumference(), RealWithinAbs(REAL(2.0) * Constants::PI, TOL(1e-10, 1e-5)));
		REQUIRE_THAT(a.OuterCircumference(), RealWithinAbs(REAL(6.0) * Constants::PI, TOL(1e-10, 1e-5)));
		REQUIRE_THAT(a.MeanCircumference(), RealWithinAbs(REAL(4.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Annulus::Circles", "[Annulus]")
	{
		...
		REQUIRE_THAT(inner.Radius(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(outer.Radius(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("RegularPolygon::Square", "[RegularPolygon]")
	{
		...
		REQUIRE_THAT(sq.SideLength(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(sq.Perimeter(), RealWithinAbs(REAL(8.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(sq.Area(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(sq.InteriorAngle(), RealWithinAbs(Constants::PI / 2, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("RegularPolygon::Hexagon", "[RegularPolygon]")
	{
		...
		REQUIRE_THAT(hex.Perimeter(), RealWithinAbs(REAL(6.0), TOL(1e-10, 1e-5)));
		
		// Interior angle = (n-2)*π/n = 4π/6 = 2π/3
		REQUIRE_THAT(hex.InteriorAngle(), RealWithinAbs(REAL(2.0) * Constants::PI / 3, TOL(1e-10, 1e-5)));
		
		// For regular hexagon with side 1: circumradius = 1, inradius = sqrt(3)/2
		REQUIRE_THAT(hex.Circumradius(), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(hex.Inradius(), RealWithinAbs(std::sqrt(REAL(3.0)) / 2, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("RegularPolygon::EquilateralTriangle", "[RegularPolygon]")
	{
		...
		REQUIRE_THAT(tri.InteriorAngle(), RealWithinAbs(Constants::PI / 3, TOL(1e-10, 1e-5)));
		
		// Area = (sqrt(3)/4) * s² = sqrt(3)
		REQUIRE_THAT(tri.Area(), RealWithinAbs(std::sqrt(REAL(3.0)), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("RegularPolygon::FromArea", "[RegularPolygon]")
	{
		...
		REQUIRE_THAT(sq.SideLength(), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Rectangle::Properties", "[Rectangle]")
	{
		...
		REQUIRE_THAT(r.Area(), RealWithinAbs(REAL(12.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(r.Perimeter(), RealWithinAbs(REAL(14.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(r.Diagonal(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(r.AspectRatio(), RealWithinAbs(REAL(0.75), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Rectangle::Square", "[Rectangle]")
	{
		...
		REQUIRE(sq.IsSquare());
		REQUIRE_THAT(sq.Width(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(sq.Height(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Rectangle::GoldenRectangle", "[Rectangle]")
	{
		...
		REQUIRE_THAT(golden.AspectRatio(), RealWithinAbs(Constants::GoldenRatio, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Rectangle::CircleRadii", "[Rectangle]")
	{
		...
		REQUIRE_THAT(r.InscribedCircleRadius(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		
		// Circumscribed circle radius = diagonal/2 = 5
		REQUIRE_THAT(r.CircumscribedCircleRadius(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Parallelogram::Properties", "[Parallelogram]")
	{
		...
		REQUIRE(p.IsValid());
		REQUIRE_THAT(p.Perimeter(), RealWithinAbs(REAL(14.0), TOL(1e-10, 1e-5)));
		
		// Area = a*b*sin(θ) = 4*3*sin(60°) = 12 * sqrt(3)/2 = 6*sqrt(3)
		REQUIRE_THAT(p.Area(), RealWithinAbs(REAL(6.0) * std::sqrt(REAL(3.0)), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Parallelogram::Heights", "[Parallelogram]")
	{
		...
		REQUIRE_THAT(p.HeightToA(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(p.HeightToB(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Rhombus::FromDiagonals", "[Rhombus]")
	{
		...
		REQUIRE(r.IsValid());
		REQUIRE_THAT(r.Diagonal1(), RealWithinAbs(REAL(6.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(r.Diagonal2(), RealWithinAbs(REAL(8.0), TOL(1e-10, 1e-5)));
		
		// Side = sqrt((d1/2)² + (d2/2)²) = sqrt(9+16) = 5
		REQUIRE_THAT(r.Side(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		
		// Area = d1*d2/2 = 24
		REQUIRE_THAT(r.Area(), RealWithinAbs(REAL(24.0), TOL(1e-10, 1e-5)));
		
		// Perimeter = 4*side = 20
		REQUIRE_THAT(r.Perimeter(), RealWithinAbs(REAL(20.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Trapezoid::Properties", "[Trapezoid]")
	{
		...
		REQUIRE_THAT(t.Area(), RealWithinAbs(REAL(15.0), TOL(1e-10, 1e-5)));
		
		// Median = (a+b)/2 = 5
		REQUIRE_THAT(t.Median(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Trapezoid::Isosceles", "[Trapezoid]")
	{
		...
		REQUIRE_THAT(t.Height(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("SphereGeom::Properties", "[SphereGeom]")
	{
		...
		REQUIRE(s.IsValid());
		REQUIRE_THAT(s.Diameter(), RealWithinAbs(REAL(6.0), TOL(1e-10, 1e-5)));
		
		// Volume = (4/3)πr³ = (4/3)π*27 = 36π
		REQUIRE_THAT(s.Volume(), RealWithinAbs(REAL(36.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Surface area = 4πr² = 36π
		REQUIRE_THAT(s.SurfaceArea(), RealWithinAbs(REAL(36.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("SphereGeom::GreatCircle", "[SphereGeom]")
	{
		...
		REQUIRE_THAT(great.Radius(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("SphereGeom::Cap", "[SphereGeom]")
	{
		...
		// Hemisphere: h = r = 2
		REQUIRE_THAT(s.CapArea(REAL(2.0)), RealWithinAbs(REAL(8.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Cap volume for hemisphere: (2/3)πr³
		Real expectedVol = (REAL(2.0) / REAL(3.0)) * Constants::PI * REAL(8.0);
		REQUIRE_THAT(s.CapVolume(REAL(2.0)), RealWithinAbs(expectedVol, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("SphereGeom::FactoryMethods", "[SphereGeom]")
	{
		...
		REQUIRE_THAT(fromVol.Radius(), RealWithinAbs(REAL(1.0), TOL(1e-10, 1e-5)));
	...
	TEST_CASE("CylinderGeom::Properties", "[CylinderGeom]")
	{
		...
		REQUIRE(c.IsValid());
		REQUIRE_THAT(c.Diameter(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
		
		// Volume = πr²h = 4π*5 = 20π
		REQUIRE_THAT(c.Volume(), RealWithinAbs(REAL(20.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Lateral area = 2πrh = 4π*5 = 20π
		REQUIRE_THAT(c.LateralArea(), RealWithinAbs(REAL(20.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Base area = πr² = 4π
		REQUIRE_THAT(c.BaseArea(), RealWithinAbs(REAL(4.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Surface area = lateral + 2*base = 20π + 8π = 28π
		REQUIRE_THAT(c.SurfaceArea(), RealWithinAbs(REAL(28.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("CylinderGeom::FromVolume", "[CylinderGeom]")
	{
		...
		REQUIRE_THAT(c.Radius(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(c.Height(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("ConeGeom::Properties", "[ConeGeom]")
	{
		...
		REQUIRE(c.IsValid());
		REQUIRE_THAT(c.SlantHeight(), RealWithinAbs(REAL(5.0), TOL(1e-10, 1e-5)));
		
		// Volume = (1/3)πr²h = (1/3)*9π*4 = 12π
		REQUIRE_THAT(c.Volume(), RealWithinAbs(REAL(12.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Lateral area = πrs = 3π*5 = 15π
		REQUIRE_THAT(c.LateralArea(), RealWithinAbs(REAL(15.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Base area = πr² = 9π
		REQUIRE_THAT(c.BaseArea(), RealWithinAbs(REAL(9.0) * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Surface area = 15π + 9π = 24π
		REQUIRE_THAT(c.SurfaceArea(), RealWithinAbs(REAL(24.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("ConeGeom::FromSlantHeight", "[ConeGeom]")
	{
		...
		REQUIRE_THAT(c.Radius(), RealWithinAbs(REAL(3.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(c.Height(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Frustum::Properties", "[Frustum]")
	{
		...
		REQUIRE_THAT(f.SlantHeight(), RealWithinAbs(std::sqrt(REAL(13.0)), TOL(1e-10, 1e-5)));
		
		// Volume = (π*h/3)(r1² + r1*r2 + r2²) = (π*3/3)(16+8+4) = π*28
		REQUIRE_THAT(f.Volume(), RealWithinAbs(REAL(28.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Frustum::Bases", "[Frustum]")
	{
		...
		REQUIRE_THAT(bottom.Radius(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(top.Radius(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Tetrahedron::Regular", "[Tetrahedron]")
	{
		...
		REQUIRE(t.IsRegular());
		REQUIRE_THAT(t.AB(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		
		// Regular tetrahedron with edge a: V = a³/(6*sqrt(2))
		Real expectedVol = REAL(8.0) / (REAL(6.0) * std::sqrt(REAL(2.0)));
		REQUIRE_THAT(t.Volume(), RealWithinAbs(expectedVol, TOL(1e-8, 1e-4)));
	}
	...
	TEST_CASE("Spheroid::Volume", "[Spheroid]")
	{
		...
		REQUIRE_THAT(s.Volume(), RealWithinAbs(REAL(24.0) * Constants::PI, TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("Spheroid::Flattening", "[Spheroid]")
	{
		...
		REQUIRE_THAT(s.Flattening(), RealWithinAbs(REAL(0.25), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("TorusGeom::Properties", "[TorusGeom]")
	{
		...
		REQUIRE_THAT(t.Volume(), RealWithinAbs(REAL(6.0) * Constants::PI * Constants::PI, TOL(1e-10, 1e-5)));
		
		// Surface area = 4π²Rr = 4π²*3*1 = 12π²
		REQUIRE_THAT(t.SurfaceArea(), RealWithinAbs(REAL(12.0) * Constants::PI * Constants::PI, TOL(1e-10, 1e-5)));
		
		REQUIRE_THAT(t.InnerRadius(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
		REQUIRE_THAT(t.OuterRadius(), RealWithinAbs(REAL(4.0), TOL(1e-10, 1e-5)));
	}
	...
	TEST_CASE("TorusGeom::TubeCrossSection", "[TorusGeom]")
	{
		...
		REQUIRE_THAT(tube.Radius(), RealWithinAbs(REAL(2.0), TOL(1e-10, 1e-5)));
	}
