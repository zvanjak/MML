...
TEST_CASE("Test_Unsymmetric_Matrix_Eigen_solver 3 x 3", "[simple]")
{
    ...
    for(int i=0; i<3; i++) 
    {
        ...
        REQUIRE(true == Utils::AreEqual(Utils::MulMatVec(mat, eigen_vector), eigen_value * eigen_vector, 1e-14));
        REQUIRE(false  == Utils::AreEqual(Utils::MulMatVec(mat, eigen_vector), eigen_value * eigen_vector, 1e-15));
    }  
}
...
TEST_CASE("Test_Unsymmetric_Matrix_Eigen_solver 5 x 5", "[simple]")
{
    ...
    for(int i=0; i<5; i++)               
    {
        ...
        REQUIRE(true == Utils::AreEqual(Utils::MulMatVec(mat, eigen_vector), eigen_value * eigen_vector, 1e-13));
        REQUIRE(false  == Utils::AreEqual(Utils::MulMatVec(mat, eigen_vector), eigen_value * eigen_vector, 1e-15));
    }  
}
...
TEST_CASE("Test_Unsymmetric_Matrix_Eigen_solver 50 x 50", "[simple]")
{
    ...
    for(int i=0; i<50; i++)
    {
        ...
        REQUIRE(true == Utils::AreEqual(Utils::MulMatVec(mat, eigen_vector), eigen_value * eigen_vector, 1e-12));
        REQUIRE(false  == Utils::AreEqual(Utils::MulMatVec(mat, eigen_vector), eigen_value * eigen_vector, 1e-15));
    }  
}