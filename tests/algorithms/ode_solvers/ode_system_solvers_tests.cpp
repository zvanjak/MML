...
namespace MML::Tests::Algorithms::ODESystemSolverTests 
{
	...
	// Test Leapfrog via ODESystemFixedStepSolver + Leapfrog_StepCalculator
	TEST_CASE("Test_Leapfrog_StepCalculator_FixedSolver", "[Leapfrog][ODESystemFixedStepSolver]") {
		TEST_PRECISION_INFO();
		TestBeds::SimpleHarmonicOscillatorODE harmOsc;
		...
		Leapfrog_StepCalculator leapfrogStep;
		ODESystemFixedStepSolver solver(harmOsc, leapfrogStep);
		ODESystemSolution sol = solver.integrate(initCond, t1, t2, numSteps);
