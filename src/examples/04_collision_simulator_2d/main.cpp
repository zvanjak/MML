...
void Demo_TwoColorMixing()
{
    ...
    // Save and visualize
    std::string filename = "results/collision_two_color_mixing.mml";
    ...
    if (success)
    {
        ...
        Visualizer::VisualizeParticleSimulation2D("collision_two_color_mixing.mml");
    }
    else
    {
...
{
    std::cout << "\n" << std::string(70, '=') << "\n";
    std::cout << "  SCENARIO 2: Shock Wave Simulation (50,000 balls)\n";
    std::cout << std::string(70, '=') << "\n\n";
    ...
    const int numSurrounding = 49900;   // Cold gas
    ...
    std::cout << "  Using " << hwThreads << " hardware threads (" 
              << hwThreads/2 << " cores)\n\n";
    ...
    // Save and visualize
    std::string filename = "results/collision_shock_wave.mml";
    ...
    if (success)
    {
        std::cout << "\nSimulation saved to: " << filename << "\n";
        std::cout << "Launching ParticleVisualizer2D...\n";
        Visualizer::VisualizeParticleSimulation2D("collision_shock_wave.mml");
    }
    else
    {
        std::cout << "\nFailed to save simulation!\n";
...
int main()
{
    ...
    std::cout << "  - collision_shock_wave.txt (50,000 balls, 500 steps)\n\n";
