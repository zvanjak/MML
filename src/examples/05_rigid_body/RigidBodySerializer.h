...
/// @brief Serialization utilities - Example 05: Rigid Body Collision Simulator
/// @details Self-contained header with serialization for rigid body simulation data:
///          - RigidBodyInfo struct
///          - SerializeResult struct
///          - RigidBodySerializer class
///
...
/// @date February 2026
///////////////////////////////////////////////////////////////////////////////////////////
#ifndef RIGID_BODY_SERIALIZER_H
#define RIGID_BODY_SERIALIZER_H
...
namespace RigidBodySim
{
    ...
    /// serializer.AddBody(RigidBodyInfo::Sphere(5.0, 0.5, "Green", "Sphere1"));
