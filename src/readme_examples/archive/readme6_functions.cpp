...
void Readme_defining_functions_case_5_usage()
{
    ...
    //Serializer::SaveRealFuncEquallySpacedDetailed(test_func, "readme_interp_test_func", x1, x2, 100, "..\\..\\results\\readme_interp_test_func.mml");
    //Serializer::SaveRealFuncEquallySpacedDetailed(f_linear, "readme_interp_linear_5_pnt", x1, x2, 500, "..\\..\\results\\readme_interp_linear_5_pnt.mml");
    //Serializer::SaveRealFuncEquallySpacedDetailed(f_polynom, "readme_interp_polynom_5_pnt", x1, x2, 100, "..\\..\\results\\readme_interp_polynom_5_pnt.mml");
    //Serializer::SaveRealFuncEquallySpacedDetailed, (x1, x2, 100, "..\\..\\results\\readme_interp_spline_5_pnt.mml");
    //Serializer::SaveRealFuncEquallySpacedDetailed(f_baryrat, "readme_interp_baryrat_5_pnt", x1, x2, 100, "..\\..\\results\\readme_interp_baryrat_5_pnt.mml");

    //const char *cmd = "..\\..\\tools\\visualizers\\real_function_visualizer\\MML_RealFunctionVisualizer.exe"
    //                    " ..\\..\\results\\readme_interp_test_func.mml"
    //                    " ..\\..\\results\\readme_interp_linear_5_pnt.mml"
    //                    " ..\\..\\results\\readme_interp_polynom_5_pnt.mml"
    //                    " ..\\..\\results\\readme_interp_spline_5_pnt.mml"
    //                    " ..\\..\\results\\readme_interp_baryrat_5_pnt.mml";
    //std::system(cmd);
}
