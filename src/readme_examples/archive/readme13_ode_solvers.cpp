...
void Readme_ode_solvers()
{
	...
	////Visualizer::VisualizeODESysSolAsMultiFunc(sol0, "Lorenz system", "demo5_lorenz_system.mml");
	//Visualizer::VisualizeODESysSolAsParamCurve3(sol0, "Lorenz system as parametric curve", "demo5_lorenz_system_as_parametric_curve.mml");
	...
	//Visualizer::VisualizeODESysSolAsParamCurve3(sol1, "Lorenz system as parametric curve", "demo5_lorenz_system_as_parametric_curve_1.mml");
	...
	//Visualizer::VisualizeODESysSolAsParamCurve3(sol2, "Lorenz system as parametric curve", "demo5_lorenz_system_as_parametric_curve_2.mml");
	...
	//Visualizer::VisualizeODESysSolAsParamCurve3(sol3, "Lorenz system as parametric curve", "demo5_lorenz_system_as_parametric_curve_3.mml");
	...
	//Visualizer::VisualizeODESysSolAsParamCurve3(sol4, "Lorenz system as parametric curve", "demo5_lorenz_system_as_parametric_curve_4.mml");
	...
	//Visualizer::VisualizeODESysSolAsParamCurve3(sol5, "Lorenz system as parametric curve", "demo5_lorenz_system_as_parametric_curve_5.mml");

	//// visualize all together
	//Visualizer::VisualizeMultiParamCurve3D({ 
	//									"demo5_lorenz_system_as_parametric_curve_1.mml",
	//									"demo5_lorenz_system_as_parametric_curve_2.mml",
	//									"demo5_lorenz_system_as_parametric_curve_3.mml",
	//									"demo5_lorenz_system_as_parametric_curve_4.mml",
	//									"demo5_lorenz_system_as_parametric_curve_5.mml"
	//								});
}