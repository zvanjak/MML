...
void Readme_Real_function_visualization()
{
    ...
    Visualizer::VisualizeMultiRealFunction({&f1, &f2}, "readme_multi_real_func", {"Func 1", "Func 2"},
                                            -10.0, 10.0, 500, "readme_multi_real_func.txt" );
}
...
void Readme_Vector_field_visualization()
{
    ...
    Visualizer::VisualizeVectorField3DCartesian(gravity_force_field, "gravity_force_field" , -200.0, 200.0, 30, -200.0, 200.0, 30, -200.0, 200.0, 30, "readme_vector_field.txt");
}
