...
void Demo_Metric_Tensors_comparison()
{
	...
	MetricTensorFromCoordTransf<Vector3Cartesian, Vector3Spherical, 3> metricCartFromSpherTransf(CoordTransfCartToSpher);

	Vector3Cartesian   pos(50.0, 2.0, -1.0);
	...
	auto spher_metric3 = metricCartFromSpherTransf(pos);
	...
	std::cout << "Spherical Metric from Cart transf:" << spher_metric3 << std::endl;
}
