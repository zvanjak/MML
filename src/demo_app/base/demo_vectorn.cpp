...
void Demo_VectorN()
{
    ...
    VectorN<Real, 5> vecN_dbl_1;                       // init vector with 5 elements
    Vec3               vecN_dbl_2(3.14159);              // init with constant value
    Vec3               vecN_dbl_3({ 1.0, 2.0, 3.0 });    // init with list of values
    VectorN<Real, 5> vecN_dbl_4(vecN_dbl_1);           // init with copy ctor
    VectorN<Real, 3> vecN_dbl_5 = vecN_dbl_2;          // init with assignment
    VectorN<Real, 3> vecN_dbl_6(std_vec);              // init with std::vector<>
    Vec3Flt            vecN_flt_1(arr);                  // init with C/C++ array
    VectorN<Real, 5> vecN_unit(3);                     // unit vector
    ...
    std::cout << "std::vector<Real> std_vec{-1.0, 5.0, -2.0};" << std::endl;
    std::cout << "float  arr[3] = {-1.0, 5.0, -2.0};" << std::endl;

    std::cout << "VectorN<Real, 5> vecN_dbl_1;                    vecN_dbl_1   = " << vecN_dbl_1 << std::endl;
    std::cout << "Vec3               vecN_dbl_2(3.14159);           vecN_dbl_2   = " << vecN_dbl_2 << std::endl;
    std::cout << "Vec3               vecN_dbl_3({ 1.0, 2.0, 3.0 }); vecN_dbl_3   = " << vecN_dbl_3 << std::endl;
    std::cout << "VectorN<Real, 5> vecN_dbl_4(vecN_dbl_1);        vecN_dbl_4   = " << vecN_dbl_4 << std::endl;
    std::cout << "VectorN<Real, 3> vecN_dbl_5 = vecN_dbl_2;       vecN_dbl_5   = " << vecN_dbl_5 << std::endl;
    std::cout << "VectorN<Real, 3> vecN_dbl_6(std_vec);           vecN_dbl_6   = " << vecN_dbl_6 << std::endl;
    std::cout << "Vec3Flt            vecN_flt_1(arr);               vecN_flt_1   = " << vecN_flt_1 << std::endl;
    std::cout << "VectorN<Real, 5> vecN_unit(3);                  vecN_unit    = " << vecN_unit << std::endl;
    ...
    VectorN<Real, 5> vecN_dbl_4_almost_equal(vecN_dbl_4);
    ...
    std::cout << "IsEqual(vecN_dbl_4, vecN_dbl_4_almost_equal, 1e-07) = " << vecN_dbl_4.IsEqualTo(vecN_dbl_4_almost_equal, Real(1e-07)) << std::endl;
    std::cout << "IsEqual(vecN_dbl_4, vecN_dbl_4_almost_equal, 1e-05) = " << vecN_dbl_4.IsEqualTo(vecN_dbl_4_almost_equal, Real(1e-05)) << std::endl;
