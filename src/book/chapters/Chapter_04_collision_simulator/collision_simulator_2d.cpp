...
void Collision_Simulator_2D_N_random_balls()
{
	...
	std::string fileName = "collision_sim_" + std::to_string(N) + "_random_balls.mml";
...
void Collision_Simulator_2D_two_types_initially_separated()
{
	...
	simulator.Serialize(GetResultFilesPath() + "collision_sim_2d_1000_x_800_1000_steps.mml", simResults, dT, 100);

	Visualizer::VisualizeParticleSimulation2D("collision_sim_2d_1000_x_800_1000_steps.mml");
...
void Collision_Simulator_2D_3()
{
	...
	simulator.Serialize(GetResultFilesPath() + "collision_sim_2d_3.mml", simResults, dT);

	Visualizer::VisualizeParticleSimulation2D("collision_sim_2d_3.mml");
}
...
void Collision_Simulator_2D_Brown_motion()
{
	...
	simulator.Serialize(GetResultFilesPath() + "collision_sim_brown_motion.mml", simResults, dT);

	//Visualizer::VisualizeParticleSimulation2D("collision_sim_brown_motion.mml");
	...
	Serializer::SaveAsParamCurve<2>(res, "PARAMETRIC_CURVE_CARTESIAN_2D", "brown_motion_main_body_path.mml",
																	0, numSteps, path.size(),
																	GetResultFilesPath() + "brown_motion_main_body_path.mml");

	Visualizer::VisualizeMultiParamCurve2D({ "brown_motion_main_body_path.mml", "brown_motion_main_body_path1.mml" , "brown_motion_main_body_path2.mml", "brown_motion_main_body_path3.mml", 
																					 "brown_motion_main_body_path4.mml" , "brown_motion_main_body_path5.mml", "brown_motion_main_body_path6.mml" });
...
{ 
	...
	// usporediti rje�enja simulacija
}
...
void Collision_Simulator_2D_Pressure_on_walls()
{
	...
	Visualizer::VisualizeRealFunction(funcTotalPressure, "Total pressure on walls during simulation", 
																		0, numSteps - 1, numSteps-1, "total_pressure_on_walls.mml");

	// visualize pressure on all four walls separately, in same graph
	
	
	//simulator.Serialize(GetResultFilesPath() + "collision_sim_pressure_on_walls.mml", simResults.BallPosList);

	//Visualizer::VisualizeParticleSimulation2D("collision_sim_pressure_on_walls.mml");
}
...
void Collision_Simulator_2D_Comparing_pressure_for_diff_N()
{
	...
	for (int i=0; i<numBallsList.size(); i++)
	{
		...
		// visualize function of total pressure on walls
		//Visualizer::VisualizeRealFunction(totalPressure, "Total pressure on walls", 0, numSteps - 1, numSteps - 1, "total_pressure_on_walls.mml");
	...
	Visualizer::VisualizeMultiRealFunction(totalPressureFuncs,
																				...
																				0, numSteps, numSteps, "total_pressure_multi_N.mml");
	...
	Visualizer::VisualizeRealFunction(avgPressureFunc, "Average pressure on walls for different number of balls", 
																		x[0], numBallsList[numBallsList.size() - 1], numSteps-1, "avg_pressure_on_walls_diff_N.mml");
}
...
void Collision_Simulator_2D_Comparing_pressure_for_diff_V()
{
	...
	Visualizer::VisualizeMultiRealFunction(totalPressureFuncs,
																				...
																				0, numSteps-1, numSteps-1, "total_pressure_multi_V.mml");
	...
	Visualizer::VisualizeRealFunction(avgPressureFunc, "Average pressure on walls for different area of container",
																		x_squared[0], maxX, 100, "avg_pressure_on_walls_diff_V.mml");
}
...
void Collision_Simulator_2D_Comparing_pressure_for_diff_speed_of_balls()
{
	...
	Visualizer::VisualizeMultiRealFunction(totalPressureFuncs,
																				...
																				0, numSteps - 1, numSteps - 1, "total_pressure_multi_speed.mml");
	...
	Visualizer::VisualizeRealFunction(avgPressureFunc, "Average pressure on walls for different speed of balls",
																		x_speed[0], maxX, 100, "avg_pressure_on_walls_diff_speed.mml");
	...
	Visualizer::VisualizeRealFunction(avgPressureSqrtFunc, "Square root of average pressure on walls for different speed of balls",
		x_speed_sqrt[0], maxX, 100, "avg_pressure_sqrt_on_walls_diff_speed.mml");
...
void Collision_Simulator_2D_Test_statistics()
{
	...
	//std::string fileName = "collision_sim_" + std::to_string(N) + "_test_statistics.mml";
