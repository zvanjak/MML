...
void Example15_tensor_of_inertia_discrete_masses()
{
...
void Example15_tensor_of_inertia_continuous_mass()
{
...
void Example15_tensor_of_inertia()
{
	std::cout << "***********************************************************************" << std::endl;
	std::cout << "****                   CHAPTER 15 - tensor of inertia               ****" << std::endl;
	std::cout << "***********************************************************************" << std::endl;

	Example15_tensor_of_inertia_discrete_masses();
	Example15_tensor_of_inertia_continuous_mass();
}