...
void Demo_Interpolation()
{
  ...
  Visualizer::VisualizeMultiRealFunction({&lin_interp, &poly_interp3, &poly_interp4, &spline_interp}, 
																				...
																				0.0, 10.0, 100, "Demo_interpolation.mml" );
}