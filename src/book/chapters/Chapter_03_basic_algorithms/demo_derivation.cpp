...
void Demo_RealFunction_Derivation()
{
...
void Demo_ScalarVectorFunction_Derivation()
{
...
void Demo_ParametricCurve_Derivation()
{
	// parametric curves
	...
	// Second derivative - optimized direct formulas (3-5 function evaluations)
	VectorN<Real, 3>    sec_f4Curve   = Derivation::NSecDer2(f4Curve, 1.0);  // O(h²), 3 evals
	
	// Third derivative - optimized direct formulas (4-6 function evaluations)
	VectorN<Real, 3>    third_f4Curve = Derivation::NThirdDer2(f4Curve, 1.0);  // O(h²), 4 evals

	// TODO - example with calculating curve tangent and curvature

}

void Demo_Derivation()
{
	Demo_RealFunction_Derivation();
	Demo_ScalarVectorFunction_Derivation();
	Demo_ParametricCurve_Derivation();
}