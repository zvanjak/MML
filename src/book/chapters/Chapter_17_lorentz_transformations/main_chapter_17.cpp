...
void Demo1_Vector4Minkowski()
{
	...
	ParametricCurve<4> line([](Real t) { return VectorN<Real, 4>{ t, 0.8 * t, 0.0, 0.0 }; });
	ParametricCurve<3> line3D([](Real t) { return VectorN<Real,3>{ 0.8 * t, 0.0, 0.0 }; } );
	...
	// visualize curve3D
	//Visualizer::VisualizeParamCurve3D(curve3D, "Curve in Minkowski space-time",	0.0, 100.0, 100, "Chapter15_curve3D.mml");
...
void Chapter17_Lorentz_as_Gallilean_transf()
{
	...
	Vector4Minkowski eventLocalRestFrame3{ 10.0, 10.0 * speed, 0.0, 0.0 };
	...
	for (int i = 0; i <= 10; ++i)
	{
		...
		Vector4Minkowski xPos{ i * 1.0, i * speed, 0.0, 0.0 };
	...
	for (int i = 10; i <= 20; ++i)
	{
		...
		Vector4Minkowski xPos{ i * 1.0, 10 * speed - (i - 10) * speed, 0.0, 0.0 };
...
void Chapter17_Moving_x_axis()
{
	std::cout << "***********************************************************************" << std::endl;
	std::cout << "***  CHAPTER 17 - Moving frame in x-axis drection transformation   ***" << std::endl;
	std::cout << "***********************************************************************" << std::endl;
...
void Chapter17_Moving_frame_general_vector_direction()
{
	std::cout << "***********************************************************************" << std::endl;
	std::cout << "***  CHAPTER 17 - Moving frame in general direction transformation  ***" << std::endl;
	std::cout << "***********************************************************************" << std::endl;

	Real speed = 0.8;
	Vec3Cart direction{ 1.0, 0.0, 0.0 }; // moving along x-axis
	...
	for (int i = 0; i <= 10; ++i)
	{
		...
		if (i == 5)
		{
			...
			Vector4Minkowski eventAtMidway = ctGeneral.transfInverse(Vector4Minkowski{ 5.0, 5.0 * speed, 0.0, 0.0 });
...
{
	std::cout << "***********************************************************************" << std::endl;
	std::cout << "****                   CHAPTER 17 - Lorentz transformation          ****" << std::endl;
	std::cout << "***********************************************************************" << std::endl;

	Demo1_Vector4Minkowski();
	//Chapter17_Lorentz_as_Gallilean_transf();
	//Chapter17_Moving_x_axis();
	//Chapter17_Moving_frame_general_vector_direction();
}
