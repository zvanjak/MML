...
namespace MPL
{
	...
	public:
		...
		void VisualizeSolution(std::string baseFileName)
		{
			...
			Visualizer::VisualizeMultiParamCurve3D({ baseFileName + "_body1.mml", baseFileName + "_body2.mml" });
		}
	};
	...
	public:
		...
		void SolveAndShowTrajectories(Real t)
		{
			...
			Visualizer::VisualizeMultiParamCurve3D({ "gravity_example_body1.mml", "gravity_example_body2.mml" });
		}
	};
} // namespace MPL
