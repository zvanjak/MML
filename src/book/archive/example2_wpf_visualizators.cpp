...
void Example3_WPF_Real_function_visualization()
{
	...
	Visualizer::VisualizeRealFunction(f1, "Simple function", Real(-10.0), Real(10.0), 501, 
																				"example3_wpf_real_func1.mml");
	...
	Visualizer::VisualizeODESysSolAsMultiFunc(sol, "Lorentz system", std::vector<std::string>{"x", "y", "z"}, "example3_wpf_lorentz.mml");
...
void Example3_WPF_Parametric_curve_2D_visualization()
{
	...
	Visualizer::VisualizeParamCurve2D(lemniscate, "Lemniscate", 0.0, 2 * Constants::PI, 101, 
																		"example3_wpf_curve_lemniscate.mml");
	...
	Visualizer::VisualizeParamCurve2D(log_spiral2, "Log spiral", 0.0, 10.0, 101, 
																		"example3_wpf_curve_log_spiral.mml");
	...
	Visualizer::VisualizeParamCurve2D(deltoid1, "Deltoid", 0.0, 2 * Constants::PI, 101, 
																		"example3_wpf_curve_deltoid.mml");
	...
	Visualizer::VisualizeParamCurve2D(astroid1, "Astroid", 0.0, 2 * Constants::PI, 101, 
																		"example3_wpf_curve_astroid.mml");
	...
	Visualizer::VisualizeParamCurve2D(arch_spiral1, "Archimedean spiral", 0.0, 11.0, 101, "example3_wpf_curve_archimedean_spiral.mml");
...
void Example3_WPF_Parametric_curve_3D_visualization()
{
	...
	Visualizer::VisualizeMultiParamCurve3D({ &toroid1, &toroid2, &toroid3 }, "toroidal spiral", 
																					...
																					"example3_wpf_curve_toroidal_spiral.mml");
	...
	Visualizer::VisualizeParamCurve3D(curve2, "Curve from points", 0.0, 1.0, 1000, 
																		"example3_wpf_curve_spline2.mml");

	// shown together
	Visualizer::VisualizeMultiParamCurve3D({ &curve, &curve2 }, "Curve from points", 0.0, 1.0, 1000, "example3_wpf_curve_spline_multi.mml");
	...
	Visualizer::VisualizeODESysSolAsParamCurve3(sol, 0, 1, 2, "Lorentz system", 
																							"example3_wpf_lorentz_system1.mml");
	...
	Visualizer::VisualizeMultiParamCurve3D({ &solCurve1, &solCurve2, &solCurve3, &solCurve4 }, 
																					"Lorentz attractor", 
																					0.0, 50.0, 10000, "example3_wpf_lorentz_system_multi.mml");

	Visualizer::VisualizeODESysSolAsParamCurve3(sol, 0, 1, 2, "Lorentz system", "example3_wpf_lorentz_system2.mml");
}
