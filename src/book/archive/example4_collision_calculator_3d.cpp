...
void Collision_simulator_3D_N_random_balls()
{
	...
	Serializer::SaveParticleSimulation3D(GetResultFilesPath() + "collision_sim_3d_example1.mml", box._balls.size(), box._width, box._height, box._depth, 
		simResult.BallPosList, box.getBallColors(), box.getBallRadii(), dT);

	Visualizer::VisualizeParticleSimulation3D("collision_sim_3d_example1.mml");
}
...
void Collision_simulator_3D_two_types_initially_separated()
{
	...
	Serializer::SaveParticleSimulation3D(GetResultFilesPath() + "collision_sim_3d_example2.mml", 
																			 box._balls.size(), box._width, box._height, box._depth,
																			 simResult.BallPosList, box.getBallColors(), box.getBallRadii(), dT);

	Visualizer::VisualizeParticleSimulation3D("collision_sim_3d_example2.mml");
}
...
void Collision_simulator_3D_ideal_gas_in_100_nm_cube()
{
	...
	Serializer::SaveParticleSimulation3D(GetResultFilesPath() + "ideal_gas.mml", box._balls.size(), box._width, box._height, box._depth,
																				simResult.BallPosList, box.getBallColors(), box.getBallRadii(), dT);

	Visualizer::VisualizeParticleSimulation3D("ideal_gas.mml");
}
...
void Collision_simulator_3D_simulating_air_as_ideal_gas_in_100_nm_cube()
{
	...
	Serializer::SaveParticleSimulation3D(GetResultFilesPath() + "air_as_ideal_gas.mml", box._balls.size(), 
																			 box._width, box._height, box._depth,
																			 simResult.BallPosList, box.getBallColors(), box.getBallRadii(), dT);

	Visualizer::VisualizeParticleSimulation3D("air_as_ideal_gas.mml");
}
