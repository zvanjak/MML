...
void Example12_artillery_shell_simulator()
{

}

// takes into account changing mass of the rocket!
void Example12_rocket_simulator()
{
}

void Example12_projectile_launch()
{
  std::cout << "***********************************************************************" << std::endl;
  ...
  VectorN<Real, 3> init_pos({ Real(lat), Real(lon), Real(h) });
