...
void TestRealFunction()
{
    ...
    std::cout << "FLTK: ";
    Visualizer::VisualizeRealFunction(f, "RealFunction - FLTK", -10.0, 10.0, 200, "test_realfunc_fltk.mml");
    std::cout << "✓\n";
    
    // Test Qt
    SetVisualizerBackend(VisualizerBackend::Qt);
    std::cout << "Qt:   ";
    Visualizer::VisualizeRealFunction(f, "RealFunction - Qt", -10.0, 10.0, 200, "test_realfunc_qt.mml");
    std::cout << "✓\n";
}
...
void TestParticleSimulation2D()
{
    ...
    std::string filename = "results/test_particles2d.mml";
    {
...
void TestParticleSimulation3D()
{
    ...
    std::string filename = "results/test_particles3d.mml";
    {
        std::ofstream out(filename);
