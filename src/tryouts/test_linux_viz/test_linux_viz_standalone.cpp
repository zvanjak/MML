...
int main()
{
    ...
    try {
        Visualizer::VisualizeRealFunction(f1, "Linux Test - Simple Function", -10.0, 10.0, 500, "linux_test_simple.mml");
    ...
    try {
        Visualizer::VisualizeRealFunction(f2, "Linux Test - Derivative", -10.0, 10.0, 500, "linux_test_derivative.mml");
    ...
    try {
        Visualizer::VisualizeMultiRealFunction({&f1, &f2}, "Linux Test - Multi Function", 
                                              {"Original", "Derivative"},
                                              -10.0, 10.0, 500, "linux_test_multi.mml");
