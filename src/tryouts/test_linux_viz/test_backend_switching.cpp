...
int main()
{
    ...
    Visualizer::VisualizeRealFunction(f, "Default Backend Test", -10.0, 10.0, 200, "backend_test_default.mml");
    ...
    std::cout << "Current backend: " << (GetVisualizerBackend() == VisualizerBackend::FLTK ? "FLTK" : "Qt") << "\n";
    Visualizer::VisualizeRealFunction(f, "Qt Backend Test", -10.0, 10.0, 200, "backend_test_qt.mml");
    ...
    std::cout << "Current backend: " << (GetVisualizerBackend() == VisualizerBackend::FLTK ? "FLTK" : "Qt") << "\n";
    Visualizer::VisualizeRealFunction(f, "FLTK Backend Test", -10.0, 10.0, 200, "backend_test_fltk.mml");
