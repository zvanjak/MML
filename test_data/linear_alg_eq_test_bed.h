...
namespace MML::Tests
{
    ...
    public:
        ...
        // mat4 eigenvalues = 23.8652 + 0. I, -3.42447 + 1.92848 I, -3.42447 - 1.92848 I,  3.8746 + 0. I, -0.290852 + 0. I}

        const static inline MML::Matrix     symm_mat4{5, 5, {1.4, 2.1, 2.1, 7.4, 9.6,
                                                             2.1, 1.5, 1.1, 0.7, 5.0,
                                                             2.1, 1.1, 9.6, 5.4, 8.8,
                                                             7.4, 0.7, 5.4, 0.4, 8.0,
                                                             9.6, 5.0, 8.8, 8.0, 7.7}};
