...
namespace MML::TestBeds
{
	...
	public:
		TestODESystemWithSolution(int n,
															...
															Vector<Real>(*inSol)(Real)) 
			: ODESystem(n, inFunc), _initial_conditions(init_cond), _solution(inSol) { }
	...
	private:
		...
		{
				{ "simple 1", ODESystem{3, TestLinODESys} },
		...
		{
				{ "simple 1", TestODESystemWithSolution{3, TestLinODESys, Vector<Real>{1.0, 2.0, 2.0}, TestLinODESys_sol} },
		...
		{
				{ "simple", TestODESystemWithEndSolution{3, TestLinODESys, Vector<Real>{1.0, 2.0, 2.0}, 0.0, 10.0, TestLinODESys_sol(10.0)} },
		};
	public:
