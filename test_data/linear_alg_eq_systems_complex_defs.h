...
namespace MML::TestBeds
{
    ...
    /**************                     3 x 3 test matrices                           **************/
    /***********************************************************************************************/
    inline const Matrix<Complex>& mat_cmplx_3x3() {
        static const Matrix<Complex> m{3, 3, { 1.0, 2.0, -1.0, 
                                                    -1.0, 5.0, 6.0, 
                                                     3.0, 1.0, 1.0 }};
        return m;
    }

    inline const Vector<Complex>& mat_cmplx_3x3_rhs0() {
        static const Vector<Complex> v{1.0, 2.0, 1.0};
        return v;
    }
    inline const Vector<Complex>& mat_cmplx_3x3_rhs0_sol() {
        static const Vector<Complex> v{0.18867924528301885, 0.41509433962264153, 0.018867924528301921};
        return v;
    }

    // Matrix properties for mat_cmplx_3x3 (same as real mat_3x3)
    inline Real mat_cmplx_3x3_det_abs() { return 53.0; }  // |det(A)|
    inline const Vector<Real>& mat_cmplx_3x3_singular_values() {
        static const Vector<Real> v{7.965662078134766, 3.4347838553531793, 1.9371568814853632};
        return v;
    }
    inline Real mat_cmplx_3x3_cond_2() { return 4.112039181691377; }
    inline int mat_cmplx_3x3_rank() { return 3; }

    /////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_1_3x3() {
        static const Matrix<Complex> m{3, 3, { Complex(1.0, 2.0), Complex(2.0, -0.5), Complex(-1.0, 2.3), 
                                                         Complex(-2.0,1.0), Complex(4.0,-2.0),  Complex(6.0,5.0), 
                                                         Complex(2.5,1.0),  Complex(1.0,-1.0),  Complex(-2.0, -4.0) }};
        return m;
    }

    inline const Vector<Complex>& mat_cmplx_1_3x3_rhs0() {
        static const Vector<Complex> v{ Complex(1.5,0.5), Complex(-2.0,1.5), Complex(-1.0,-2.0)};
        return v;
    }
    inline const Vector<Complex>& mat_cmplx_1_3x3_rhs0_sol() {
        static const Vector<Complex> v{ Complex(0.693423783306577,-1.25000647849031),
    ...
    inline Real mat_cmplx_1_3x3_det_abs() { return 144.36547296686918; }  // |det(A)|
    inline const Vector<Real>& mat_cmplx_1_3x3_singular_values() {
        static const Vector<Real> v{10.20912316755949, 5.028959556700652, 2.815033298093671};
        return v;
    }
    inline Real mat_cmplx_1_3x3_cond_2() { return 3.6263579631689193; }
    inline int mat_cmplx_1_3x3_rank() { return 3; }

    /////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_1_5x5() {
        static const Matrix<Complex> m{5, 5, { Complex(1.0,2.0),  Complex(2.0,-0.5), Complex(-1.0, 2.3), Complex(1.8,-3.0),  Complex(-2.5,3.7), 
    ...
    inline const Vector<Complex>& mat_cmplx_1_5x5_rhs0() {
        static const Vector<Complex> v{ Complex(1.5,0.5), Complex(-2.0,1.5), Complex(-1.0,-2.0), Complex(1.0,-2.5), Complex(-1.8,2.1)};
        return v;
    }
    inline const Vector<Complex>& mat_cmplx_1_5x5_rhs0_sol() {
        static const Vector<Complex> v{ Complex(0.901430270043644,1.58987437993965),
    ...
    inline Real mat_cmplx_1_5x5_det_abs() { return 10168.952903809948; }  // |det(A)|
    inline const Vector<Real>& mat_cmplx_1_5x5_singular_values() {
        static const Vector<Real> v{15.64174282618698, 9.00912568656689, 5.696377816847538, 4.137858398839877, 2.380802820168614};
        return v;
    }
    inline Real mat_cmplx_1_5x5_cond_2() { return 6.570844779227217; }
    inline int mat_cmplx_1_5x5_rank() { return 5; }

    //////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_2_5x5() {
        static const Matrix<Complex> m{5, 5, {
    ...
    inline const Vector<Complex>& mat_cmplx_2_5x5_rhs0() {
        static const Vector<Complex> v{
            Complex(1.1,2.7),
            Complex(0.1,2.9),
            Complex(0.7,2.1),
            Complex(-0.1,0.5),
    ...
    inline const Vector<Complex>& mat_cmplx_2_5x5_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_2_5x5_det_abs() { return 13745.1507590657; }
    inline const Vector<Real>& mat_cmplx_2_5x5_singular_values() {
        static const Vector<Real> v{16.1973119257448, 10.7879205362089, 6.40784516509668, 6.0423260356214, 2.03166761650746};
        return v;
    }
    inline Real mat_cmplx_2_5x5_cond_2() { return 7.97242215908764; }
    inline int mat_cmplx_2_5x5_rank() { return 5; }

    //////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_3_5x5() {
        static const Matrix<Complex> m{5, 5, {
    ...
    inline const Vector<Complex>& mat_cmplx_3_5x5_rhs0() {
        static const Vector<Complex> v{
            Complex(-2.2,2.5),
            Complex(-1.1,-0.7),
            Complex(0.3,-2.2),
    ...
    inline const Vector<Complex>& mat_cmplx_3_5x5_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_3_5x5_det_abs() { return 6319.66771674941; }
    inline const Vector<Real>& mat_cmplx_3_5x5_singular_values() {
        static const Vector<Real> v{13.3205460279412, 9.39155667384619, 6.02046598723545, 4.85473027591569, 1.72838074627172};
        return v;
    }
    inline Real mat_cmplx_3_5x5_cond_2() { return 7.70695117767013; }
    inline int mat_cmplx_3_5x5_rank() { return 5; }

    //////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_4_5x5() {
        static const Matrix<Complex> m{5, 5, {
    ...
    inline const Vector<Complex>& mat_cmplx_4_5x5_rhs0() {
        static const Vector<Complex> v{
            Complex(1.5,-1.1),
            Complex(-2.3,-2.4),
            Complex(-3.0,0.5),
    ...
    inline const Vector<Complex>& mat_cmplx_4_5x5_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_4_5x5_det_abs() { return 35140.2960834746; }
    inline const Vector<Real>& mat_cmplx_4_5x5_singular_values() {
        static const Vector<Real> v{16.4968668117334, 11.4058088404484, 8.20284126627676, 6.24295130117635, 3.64689790129684};
        return v;
    }
    inline Real mat_cmplx_4_5x5_cond_2() { return 4.52353404406171; }
    inline int mat_cmplx_4_5x5_rank() { return 5; }

    /***********************************************************************************************/
    /**************                     8 x 8 test matrices                           **************/
    /***********************************************************************************************/
    inline const Matrix<Complex>& mat_cmplx_1_8x8() {
        static const Matrix<Complex> m{8, 8, {
    ...
    inline const Vector<Complex>& mat_cmplx_1_8x8_rhs0() {
        static const Vector<Complex> v{
            Complex(-2.4,-0.6),
            Complex(-1.2,1.5),
            Complex(1.7,-2.0),
    ...
    inline const Vector<Complex>& mat_cmplx_1_8x8_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_1_8x8_det_abs() { return 8254361.91150796; }
    inline const Vector<Real>& mat_cmplx_1_8x8_singular_values() {
        static const Vector<Real> v{20.7329056394107, 17.1020495055299, 12.3211712343142, 9.14017764485158, 7.61605888733823, 5.18445288908348, 3.62879622218723, 1.44268906430648};
        return v;
    }
    inline Real mat_cmplx_1_8x8_cond_2() { return 14.3710146228753; }
    inline int mat_cmplx_1_8x8_rank() { return 8; }

    //////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_2_8x8() {
        static const Matrix<Complex> m{8, 8, {
    ...
    inline const Vector<Complex>& mat_cmplx_2_8x8_rhs0() {
        static const Vector<Complex> v{
            Complex(-0.8,0.5),
            Complex(-0.8,-0.5),
            Complex(0.8,1.8),
    ...
    inline const Vector<Complex>& mat_cmplx_2_8x8_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_2_8x8_det_abs() { return 9681017.30839477; }
    inline const Vector<Real>& mat_cmplx_2_8x8_singular_values() {
        static const Vector<Real> v{17.9783905280538, 17.0468894260995, 13.0089171954949, 10.7846443438304, 8.43566113581774, 5.55392678710442, 2.69870097150435, 1.78075439196711};
        return v;
    }
    inline Real mat_cmplx_2_8x8_cond_2() { return 10.0959405795394; }
    inline int mat_cmplx_2_8x8_rank() { return 8; }

    //////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_3_8x8() {
        static const Matrix<Complex> m{8, 8, {
    ...
    inline const Vector<Complex>& mat_cmplx_3_8x8_rhs0() {
        static const Vector<Complex> v{
            Complex(0.8,1.1),
            Complex(2.3,2.7),
            Complex(-1.4,0.0),
    ...
    inline const Vector<Complex>& mat_cmplx_3_8x8_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_3_8x8_det_abs() { return 5323054.71961043; }
    inline const Vector<Real>& mat_cmplx_3_8x8_singular_values() {
        static const Vector<Real> v{19.1813429563283, 15.3590286176189, 12.4259062472838, 9.69670848034898, 6.7671725337737, 5.44102025627927, 3.49898640472805, 1.16395425345961};
        return v;
    }
    inline Real mat_cmplx_3_8x8_cond_2() { return 16.4794646347274; }
    inline int mat_cmplx_3_8x8_rank() { return 8; }

    /***********************************************************************************************/
    /**************                    10 x 10 test matrices                          **************/
    /***********************************************************************************************/
    inline const Matrix<Complex>& mat_cmplx_1_10x10() {
        static const Matrix<Complex> m{10, 10, {
    ...
    inline const Vector<Complex>& mat_cmplx_1_10x10_rhs0() {
        static const Vector<Complex> v{
            Complex(1.9,0.2),
            Complex(1.0,-2.8),
            Complex(2.8,0.4),
    ...
    inline const Vector<Complex>& mat_cmplx_1_10x10_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_1_10x10_det_abs() { return 1042200039.51399; }
    inline const Vector<Real>& mat_cmplx_1_10x10_singular_values() {
        static const Vector<Real> v{22.7185465473606, 19.8152614906404, 17.208921749824, 14.7435183297016, 11.5502006454006, 10.2323923940024, 7.627380102872, 5.79022085629406, 2.68282848064847, 0.651607085870877};
        return v;
    }
    inline Real mat_cmplx_1_10x10_cond_2() { return 34.8654074517885; }
    inline int mat_cmplx_1_10x10_rank() { return 10; }

    //////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_2_10x10() {
        static const Matrix<Complex> m{10, 10, {
    ...
    inline const Vector<Complex>& mat_cmplx_2_10x10_rhs0() {
        static const Vector<Complex> v{
            Complex(1.3,-2.2),
            Complex(-1.5,2.5),
            Complex(3.0,0.0),
    ...
    inline const Vector<Complex>& mat_cmplx_2_10x10_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_2_10x10_det_abs() { return 3907151884.60909; }
    inline const Vector<Real>& mat_cmplx_2_10x10_singular_values() {
        static const Vector<Real> v{22.3486893729876, 18.4057371396619, 16.0143867894748, 14.9306536661108, 13.7285234336414, 9.71270306087155, 8.32484844148929, 7.14073463579936, 6.0902048638322, 0.82290710430045};
        return v;
    }
    inline Real mat_cmplx_2_10x10_cond_2() { return 27.1582165911499; }
    inline int mat_cmplx_2_10x10_rank() { return 10; }

    //////////////////////////////////////////////////////////////////////////////////////////////////
    inline const Matrix<Complex>& mat_cmplx_3_10x10() {
        static const Matrix<Complex> m{10, 10, {
    ...
    inline const Vector<Complex>& mat_cmplx_3_10x10_rhs0() {
        static const Vector<Complex> v{
            Complex(-0.0,0.6),
            Complex(-1.9,1.8),
            Complex(2.2,1.8),
    ...
    inline const Vector<Complex>& mat_cmplx_3_10x10_rhs0_sol() {
        static const Vector<Complex> v{
    ...
    inline Real mat_cmplx_3_10x10_det_abs() { return 2412748639.16755; }
    inline const Vector<Real>& mat_cmplx_3_10x10_singular_values() {
        static const Vector<Real> v{22.5163950951509, 20.275670042204, 17.0822720041155, 13.923744195654, 12.0162310557434, 9.04808201323421, 6.67171858689903, 4.89006586995963, 3.45262581668275, 1.81430205907735};
        return v;
    }
    inline Real mat_cmplx_3_10x10_cond_2() { return 12.410499664318; }
    inline int mat_cmplx_3_10x10_rank() { return 10; }
}
#endif
